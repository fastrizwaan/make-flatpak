/*** Autogenerated by WIDL 5.0.3 from mfreadwrite.idl - Do not edit ***/
...
/*** IMFSourceReader methods ***/
static FORCEINLINE HRESULT IMFSourceReaderEx_GetStreamSelection(IMFSourceReaderEx* This,DWORD index,BOOL *selected) {
    return This->lpVtbl->GetStreamSelection(This,index,selected);
}
static FORCEINLINE HRESULT IMFSourceReaderEx_SetStreamSelection(IMFSourceReaderEx* This,DWORD index,BOOL selected) {
    return This->lpVtbl->SetStreamSelection(This,index,selected);
}
