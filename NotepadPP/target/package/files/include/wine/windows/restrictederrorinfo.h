/*** Autogenerated by WIDL 5.0.3 from restrictederrorinfo.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IRestrictedErrorInfo_QueryInterface(IRestrictedErrorInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IRestrictedErrorInfo_AddRef(IRestrictedErrorInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IRestrictedErrorInfo_Release(IRestrictedErrorInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IRestrictedErrorInfo methods ***/
static FORCEINLINE HRESULT IRestrictedErrorInfo_GetErrorDetails(IRestrictedErrorInfo* This,BSTR *desc,HRESULT *error,BSTR *restricted_desc,BSTR *sid) {
    return This->lpVtbl->GetErrorDetails(This,desc,error,restricted_desc,sid);
}
static FORCEINLINE HRESULT IRestrictedErrorInfo_GetReference(IRestrictedErrorInfo* This,BSTR *reference) {
