/*** Autogenerated by WIDL 5.0.3 from wpcapi.idl - Do not edit ***/
...
/*** IWPCSettings methods ***/
static FORCEINLINE HRESULT IWPCSettings_IsLoggingRequired(IWPCSettings* This,BOOL *pfRequired) {
...
/*** IWPCSettings methods ***/
static FORCEINLINE HRESULT IWPCGamesSettings_IsLoggingRequired(IWPCGamesSettings* This,BOOL *pfRequired) {
    return This->lpVtbl->IsLoggingRequired(This,pfRequired);
}
...
/*** IWPCSettings methods ***/
static FORCEINLINE HRESULT IWPCWebSettings_IsLoggingRequired(IWPCWebSettings* This,BOOL *pfRequired) {
    return This->lpVtbl->IsLoggingRequired(This,pfRequired);
}
...
static FORCEINLINE HRESULT IWPCWebSettings_RequestURLOverride(IWPCWebSettings* This,HWND hWnd,LPCWSTR pcszURL,DWORD cURLs,LPCWSTR *ppcszSubURLs,BOOL *pfChanged) {
