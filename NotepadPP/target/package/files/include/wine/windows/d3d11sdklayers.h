/*** Autogenerated by WIDL 5.0.3 from d3d11sdklayers.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ID3D11InfoQueue_SetBreakOnCategory(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category,BOOL bEnable) {
    return This->lpVtbl->SetBreakOnCategory(This,Category,bEnable);
}
static FORCEINLINE HRESULT ID3D11InfoQueue_SetBreakOnSeverity(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity,BOOL bEnable) {
    return This->lpVtbl->SetBreakOnSeverity(This,Severity,bEnable);
}
static FORCEINLINE HRESULT ID3D11InfoQueue_SetBreakOnID(ID3D11InfoQueue* This,D3D11_MESSAGE_ID ID,BOOL bEnable) {
    return This->lpVtbl->SetBreakOnID(This,ID,bEnable);
}
static FORCEINLINE BOOL ID3D11InfoQueue_GetBreakOnCategory(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category) {
    return This->lpVtbl->GetBreakOnCategory(This,Category);
}
static FORCEINLINE BOOL ID3D11InfoQueue_GetBreakOnSeverity(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity) {
    return This->lpVtbl->GetBreakOnSeverity(This,Severity);
}
static FORCEINLINE BOOL ID3D11InfoQueue_GetBreakOnID(ID3D11InfoQueue* This,D3D11_MESSAGE_ID ID) {
    return This->lpVtbl->GetBreakOnID(This,ID);
}
static FORCEINLINE void ID3D11InfoQueue_SetMuteDebugOutput(ID3D11InfoQueue* This,BOOL bMute) {
    This->lpVtbl->SetMuteDebugOutput(This,bMute);
}
static FORCEINLINE BOOL ID3D11InfoQueue_GetMuteDebugOutput(ID3D11InfoQueue* This) {
