...
flatpak --user install -y --app --bundle "$DIR/asdf.flatpak" || echo "Installation failed. Check if you have Flatpak properly configured. See http://flatpak.org/ for more info."
