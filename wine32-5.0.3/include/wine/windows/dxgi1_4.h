/*** Autogenerated by WIDL 5.0.3 from dxgi1_4.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IDXGIOutput4_TakeOwnership(IDXGIOutput4* This,IUnknown *device,BOOL exclusive) {
