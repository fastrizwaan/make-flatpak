/*** Autogenerated by WIDL 5.0.3 from objidl.idl - Do not edit ***/
...
static FORCEINLINE DWORD IExternalConnection_ReleaseConnection(IExternalConnection* This,DWORD extconn,DWORD reserved,BOOL fLastReleaseCloses) {
...
/*** IMalloc methods ***/
static FORCEINLINE LPVOID IMalloc_Alloc(IMalloc* This,SIZE_T cb) {
    return This->lpVtbl->Alloc(This,cb);
}
static FORCEINLINE LPVOID IMalloc_Realloc(IMalloc* This,LPVOID pv,SIZE_T cb) {
    return This->lpVtbl->Realloc(This,pv,cb);
}
static FORCEINLINE void IMalloc_Free(IMalloc* This,LPVOID pv) {
    This->lpVtbl->Free(This,pv);
}
static FORCEINLINE SIZE_T IMalloc_GetSize(IMalloc* This,LPVOID pv) {
    return This->lpVtbl->GetSize(This,pv);
}
static FORCEINLINE int IMalloc_DidAlloc(IMalloc* This,LPVOID pv) {
...
static FORCEINLINE LPVOID IMallocSpy_PostAlloc(IMallocSpy* This,LPVOID pActual) {
    return This->lpVtbl->PostAlloc(This,pActual);
}
static FORCEINLINE LPVOID IMallocSpy_PreFree(IMallocSpy* This,LPVOID pRequest,BOOL fSpyed) {
    return This->lpVtbl->PreFree(This,pRequest,fSpyed);
}
static FORCEINLINE void IMallocSpy_PostFree(IMallocSpy* This,BOOL fSpyed) {
    This->lpVtbl->PostFree(This,fSpyed);
}
static FORCEINLINE SIZE_T IMallocSpy_PreRealloc(IMallocSpy* This,LPVOID pRequest,SIZE_T cbRequest,LPVOID *ppNewRequest,BOOL fSpyed) {
    return This->lpVtbl->PreRealloc(This,pRequest,cbRequest,ppNewRequest,fSpyed);
}
static FORCEINLINE LPVOID IMallocSpy_PostRealloc(IMallocSpy* This,LPVOID pActual,BOOL fSpyed) {
    return This->lpVtbl->PostRealloc(This,pActual,fSpyed);
}
static FORCEINLINE LPVOID IMallocSpy_PreGetSize(IMallocSpy* This,LPVOID pRequest,BOOL fSpyed) {
    return This->lpVtbl->PreGetSize(This,pRequest,fSpyed);
}
static FORCEINLINE SIZE_T IMallocSpy_PostGetSize(IMallocSpy* This,SIZE_T cbActual,BOOL fSpyed) {
    return This->lpVtbl->PostGetSize(This,cbActual,fSpyed);
}
static FORCEINLINE LPVOID IMallocSpy_PreDidAlloc(IMallocSpy* This,LPVOID pRequest,BOOL fSpyed) {
    return This->lpVtbl->PreDidAlloc(This,pRequest,fSpyed);
}
static FORCEINLINE int IMallocSpy_PostDidAlloc(IMallocSpy* This,LPVOID pRequest,BOOL fSpyed,int fActual) {
...
static FORCEINLINE BOOL IRunnableObject_IsRunning(IRunnableObject* This) {
    return This->lpVtbl->IsRunning(This);
}
static FORCEINLINE HRESULT IRunnableObject_LockRunning(IRunnableObject* This,BOOL fLock,BOOL fLastUnlockCloses) {
    return This->lpVtbl->LockRunning(This,fLock,fLastUnlockCloses);
}
static FORCEINLINE HRESULT IRunnableObject_SetContainedObject(IRunnableObject* This,BOOL fContained) {
...
static FORCEINLINE HRESULT IPersistStream_Save(IPersistStream* This,IStream *pStm,BOOL fClearDirty) {
...
static FORCEINLINE HRESULT IMoniker_Save(IMoniker* This,IStream *pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
...
static FORCEINLINE HRESULT IMoniker_ComposeWith(IMoniker* This,IMoniker *pmkRight,BOOL fOnlyIfNotGeneric,IMoniker **ppmkComposite) {
    return This->lpVtbl->ComposeWith(This,pmkRight,fOnlyIfNotGeneric,ppmkComposite);
}
static FORCEINLINE HRESULT IMoniker_Enum(IMoniker* This,BOOL fForward,IEnumMoniker **ppenumMoniker) {
...
static FORCEINLINE HRESULT IPersistFile_Save(IPersistFile* This,LPCOLESTR pszFileName,BOOL fRemember) {
...
static FORCEINLINE HRESULT IPersistStorage_Save(IPersistStorage* This,IStorage *pStgSave,BOOL fSameAsLoad) {
...
static FORCEINLINE HRESULT IFillLockBytes_Terminate(IFillLockBytes* This,BOOL bCanceled) {
...
/*** IProgressNotify methods ***/
static FORCEINLINE HRESULT IProgressNotify_OnProgress(IProgressNotify* This,DWORD dwProgressCurrent,DWORD dwProgressMaximum,BOOL fAccurate,BOOL fOwner) {
...
static FORCEINLINE HRESULT IDataObject_SetData(IDataObject* This,FORMATETC *pformatetc,STGMEDIUM *pmedium,BOOL fRelease) {
...
/*** IClientSecurity methods ***/
static FORCEINLINE HRESULT IClientSecurity_QueryBlanket(IClientSecurity* This,IUnknown *pProxy,DWORD *pAuthnSvc,DWORD *pAuthzSvc,OLECHAR **pServerPrincName,DWORD *pAuthnLevel,DWORD *pImpLevel,void **pAuthInfo,DWORD *pCapabilities) {
...
static FORCEINLINE HRESULT IClientSecurity_SetBlanket(IClientSecurity* This,IUnknown *pProxy,DWORD AuthnSvc,DWORD AuthzSvc,OLECHAR *pServerPrincName,DWORD AuthnLevel,DWORD ImpLevel,void *pAuthInfo,DWORD Capabilities) {
...
static FORCEINLINE BOOL IServerSecurity_IsImpersonating(IServerSecurity* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IAsyncSetup_QueryInterface(IAsyncSetup* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IAsyncSetup_AddRef(IAsyncSetup* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IAsyncSetup_Release(IAsyncSetup* This) {
    return This->lpVtbl->Release(This);
}
/*** IAsyncSetup methods ***/
static FORCEINLINE HRESULT IAsyncSetup_GetAsyncManager(IAsyncSetup* This,REFIID riid,IUnknown *pOuter,DWORD dwFlags,IUnknown **ppInner,IAsyncManager **ppAsyncMgr) {
...
/*** IRpcOptions methods ***/
static FORCEINLINE HRESULT IRpcOptions_Set(IRpcOptions* This,IUnknown *pPrx,DWORD dwProperty,ULONG_PTR dwValue) {
    return This->lpVtbl->Set(This,pPrx,dwProperty,dwValue);
}
static FORCEINLINE HRESULT IRpcOptions_Query(IRpcOptions* This,IUnknown *pPrx,DWORD dwProperty,ULONG_PTR *pdwValue) {
...
/*** IGlobalOptions methods ***/
static FORCEINLINE HRESULT IGlobalOptions_Set(IGlobalOptions* This,GLOBALOPT_PROPERTIES property,ULONG_PTR value) {
    return This->lpVtbl->Set(This,property,value);
}
static FORCEINLINE HRESULT IGlobalOptions_Query(IGlobalOptions* This,GLOBALOPT_PROPERTIES property,ULONG_PTR *value) {
...
/*** IDummyHICONIncluder methods ***/
static FORCEINLINE HRESULT IDummyHICONIncluder_Dummy(IDummyHICONIncluder* This,HICON hIcon,HDC hdc) {
...
/*** IApartmentShutdown methods ***/
static FORCEINLINE void IApartmentShutdown_OnUninitialize(IApartmentShutdown* This,UINT64 identifier) {
...
/*** IContext methods ***/
static FORCEINLINE HRESULT IContext_SetProperty(IContext* This,REFGUID policyId,CPFLAGS flags,IUnknown *pUnk) {
    return This->lpVtbl->SetProperty(This,policyId,flags,pUnk);
}
static FORCEINLINE HRESULT IContext_RemoveProperty(IContext* This,REFGUID policyId) {
    return This->lpVtbl->RemoveProperty(This,policyId);
}
static FORCEINLINE HRESULT IContext_GetProperty(IContext* This,REFGUID guid,CPFLAGS *pFlags,IUnknown **ppUnk) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IObjContext_QueryInterface(IObjContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IObjContext_AddRef(IObjContext* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IObjContext_Release(IObjContext* This) {
    return This->lpVtbl->Release(This);
}
/*** IContext methods ***/
static FORCEINLINE HRESULT IObjContext_SetProperty(IObjContext* This,REFGUID policyId,CPFLAGS flags,IUnknown *pUnk) {
    return This->lpVtbl->SetProperty(This,policyId,flags,pUnk);
}
static FORCEINLINE HRESULT IObjContext_RemoveProperty(IObjContext* This,REFGUID policyId) {
    return This->lpVtbl->RemoveProperty(This,policyId);
}
static FORCEINLINE HRESULT IObjContext_GetProperty(IObjContext* This,REFGUID guid,CPFLAGS *pFlags,IUnknown **ppUnk) {
    return This->lpVtbl->GetProperty(This,guid,pFlags,ppUnk);
}
static FORCEINLINE HRESULT IObjContext_EnumContextProps(IObjContext* This,IEnumContextProps **ppEnumContextProps) {
    return This->lpVtbl->EnumContextProps(This,ppEnumContextProps);
}
/*** IObjContext methods ***/
static FORCEINLINE void IObjContext_Reserved1(IObjContext* This) {
    This->lpVtbl->Reserved1(This);
}
static FORCEINLINE void IObjContext_Reserved2(IObjContext* This) {
    This->lpVtbl->Reserved2(This);
}
static FORCEINLINE void IObjContext_Reserved3(IObjContext* This) {
    This->lpVtbl->Reserved3(This);
}
static FORCEINLINE void IObjContext_Reserved4(IObjContext* This) {
    This->lpVtbl->Reserved4(This);
}
static FORCEINLINE void IObjContext_Reserved5(IObjContext* This) {
    This->lpVtbl->Reserved5(This);
}
static FORCEINLINE void IObjContext_Reserved6(IObjContext* This) {
    This->lpVtbl->Reserved6(This);
}
static FORCEINLINE void IObjContext_Reserved7(IObjContext* This) {
