/*** Autogenerated by WIDL 5.0.3 from mfidl.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFQualityManager_QueryInterface(IMFQualityManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFQualityManager_AddRef(IMFQualityManager* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFQualityManager_Release(IMFQualityManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityManager methods ***/
static FORCEINLINE HRESULT IMFQualityManager_NotifyTopology(IMFQualityManager* This,IMFTopology *topology) {
    return This->lpVtbl->NotifyTopology(This,topology);
}
static FORCEINLINE HRESULT IMFQualityManager_NotifyPresentationClock(IMFQualityManager* This,IMFPresentationClock *clock) {
    return This->lpVtbl->NotifyPresentationClock(This,clock);
}
static FORCEINLINE HRESULT IMFQualityManager_NotifyProcessInput(IMFQualityManager* This,IMFTopologyNode *node,LONG input_index,IMFSample *sample) {
    return This->lpVtbl->NotifyProcessInput(This,node,input_index,sample);
}
static FORCEINLINE HRESULT IMFQualityManager_NotifyProcessOutput(IMFQualityManager* This,IMFTopologyNode *node,LONG output_index,IMFSample *sample) {
    return This->lpVtbl->NotifyProcessOutput(This,node,output_index,sample);
}
static FORCEINLINE HRESULT IMFQualityManager_NotifyQualityEvent(IMFQualityManager* This,IUnknown *object,IMFMediaEvent *event) {
    return This->lpVtbl->NotifyQualityEvent(This,object,event);
}
static FORCEINLINE HRESULT IMFQualityManager_Shutdown(IMFQualityManager* This) {
    return This->lpVtbl->Shutdown(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFLocalMFTRegistration_QueryInterface(IMFLocalMFTRegistration* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFLocalMFTRegistration_AddRef(IMFLocalMFTRegistration* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFLocalMFTRegistration_Release(IMFLocalMFTRegistration* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFLocalMFTRegistration methods ***/
static FORCEINLINE HRESULT IMFLocalMFTRegistration_RegisterMFTs(IMFLocalMFTRegistration* This,MFT_REGISTRATION_INFO *info,DWORD count) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFMediaSourceTopologyProvider_QueryInterface(IMFMediaSourceTopologyProvider* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFMediaSourceTopologyProvider_AddRef(IMFMediaSourceTopologyProvider* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFMediaSourceTopologyProvider_Release(IMFMediaSourceTopologyProvider* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFMediaSourceTopologyProvider methods ***/
static FORCEINLINE HRESULT IMFMediaSourceTopologyProvider_GetMediaSourceTopology(IMFMediaSourceTopologyProvider* This,IMFPresentationDescriptor *pd,IMFTopology **topology) {
