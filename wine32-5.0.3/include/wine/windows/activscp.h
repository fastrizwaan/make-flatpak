/*** Autogenerated by WIDL 5.0.3 from activscp.idl - Do not edit ***/
...
/*** IActiveScriptGarbageCollector methods ***/
static FORCEINLINE HRESULT IActiveScriptGarbageCollector_CollectGarbage(IActiveScriptGarbageCollector* This,SCRIPTGCTYPE gctype) {
