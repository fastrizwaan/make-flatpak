/*** Autogenerated by WIDL 5.0.3 from shobjidl.idl - Do not edit ***/
...
typedef struct __WIDL_shobjidl_generated_name_00000022 {
    GUID guidSearch;
    WCHAR wszFriendlyName[80];
    WCHAR wszUrl[2084];
} EXTRASEARCH;
typedef struct __WIDL_shobjidl_generated_name_00000022 *LPEXTRASEARCH;
...
typedef struct __WIDL_shobjidl_generated_name_00000023 *LPSHCOLUMNID;
...
typedef enum __WIDL_shobjidl_generated_name_00000024 {
...
typedef struct __WIDL_shobjidl_generated_name_00000025 {
    UINT ViewMode;
    UINT fFlags;
} FOLDERSETTINGS;
typedef struct __WIDL_shobjidl_generated_name_00000025 *PFOLDERSETTINGS;
typedef struct __WIDL_shobjidl_generated_name_00000025 *LPFOLDERSETTINGS;
...
typedef struct __WIDL_shobjidl_generated_name_00000027 *LPSHDRAGIMAGE;
...
static FORCEINLINE HRESULT ISearchContext_GetSearchStyle(ISearchContext* This,DWORD *pdwSearchStyle) {
...
static FORCEINLINE HRESULT IFileDialogControlEvents_OnCheckButtonToggled(IFileDialogControlEvents* This,IFileDialogCustomize *pfdc,DWORD dwIDCtl,BOOL bChecked) {
...
static FORCEINLINE HRESULT ITransferAdviseSink_ConfirmEncryptionLoss(ITransferAdviseSink* This,IShellItem *source) {
...
/*** IItemNameLimits methods ***/
static FORCEINLINE HRESULT IItemNameLimits_GetValidCharacters(IItemNameLimits* This,LPWSTR *validchars,LPWSTR *invalidchars) {
    return This->lpVtbl->GetValidCharacters(This,validchars,invalidchars);
}
static FORCEINLINE HRESULT IItemNameLimits_GetMaxLength(IItemNameLimits* This,LPCWSTR name,int *max_length) {
...
/*** IPreviewHandlerFrame methods ***/
static FORCEINLINE HRESULT IPreviewHandlerFrame_GetWindowContext(IPreviewHandlerFrame* This,PREVIEWHANDLERFRAMEINFO *info) {
    return This->lpVtbl->GetWindowContext(This,info);
}
static FORCEINLINE HRESULT IPreviewHandlerFrame_TranslateAccelerator(IPreviewHandlerFrame* This,MSG *msg) {
