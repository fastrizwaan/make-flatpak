/*** Autogenerated by WIDL 5.0.3 from wbemcli.idl - Do not edit ***/
...
/*** IUnsecuredApartment methods ***/
static FORCEINLINE HRESULT IUnsecuredApartment_CreateObjectStub(IUnsecuredApartment* This,IUnknown *object,IUnknown **stub) {
...
/*** IUnsecuredApartment methods ***/
static FORCEINLINE HRESULT IWbemUnsecuredApartment_CreateObjectStub(IWbemUnsecuredApartment* This,IUnknown *object,IUnknown **stub) {
    return This->lpVtbl->CreateObjectStub(This,object,stub);
}
/*** IWbemUnsecuredApartment methods ***/
static FORCEINLINE HRESULT IWbemUnsecuredApartment_CreateSinkStub(IWbemUnsecuredApartment* This,IWbemObjectSink *sink,DWORD flags,const WCHAR *reserved,IWbemObjectSink **stub) {
