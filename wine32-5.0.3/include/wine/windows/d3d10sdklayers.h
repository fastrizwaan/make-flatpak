/*** Autogenerated by WIDL 5.0.3 from d3d10sdklayers.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ID3D10InfoQueue_SetBreakOnCategory(ID3D10InfoQueue* This,D3D10_MESSAGE_CATEGORY category,BOOL enable) {
    return This->lpVtbl->SetBreakOnCategory(This,category,enable);
}
static FORCEINLINE HRESULT ID3D10InfoQueue_SetBreakOnSeverity(ID3D10InfoQueue* This,D3D10_MESSAGE_SEVERITY severity,BOOL enable) {
    return This->lpVtbl->SetBreakOnSeverity(This,severity,enable);
}
static FORCEINLINE HRESULT ID3D10InfoQueue_SetBreakOnID(ID3D10InfoQueue* This,D3D10_MESSAGE_ID id,BOOL enable) {
    return This->lpVtbl->SetBreakOnID(This,id,enable);
}
static FORCEINLINE BOOL ID3D10InfoQueue_GetBreakOnCategory(ID3D10InfoQueue* This,D3D10_MESSAGE_CATEGORY category) {
    return This->lpVtbl->GetBreakOnCategory(This,category);
}
static FORCEINLINE BOOL ID3D10InfoQueue_GetBreakOnSeverity(ID3D10InfoQueue* This,D3D10_MESSAGE_SEVERITY severity) {
    return This->lpVtbl->GetBreakOnSeverity(This,severity);
}
static FORCEINLINE BOOL ID3D10InfoQueue_GetBreakOnID(ID3D10InfoQueue* This,D3D10_MESSAGE_ID id) {
    return This->lpVtbl->GetBreakOnID(This,id);
}
static FORCEINLINE void ID3D10InfoQueue_SetMuteDebugOutput(ID3D10InfoQueue* This,BOOL mute) {
    This->lpVtbl->SetMuteDebugOutput(This,mute);
}
static FORCEINLINE BOOL ID3D10InfoQueue_GetMuteDebugOutput(ID3D10InfoQueue* This) {
