/*** Autogenerated by WIDL 5.0.3 from sapi.idl - Do not edit ***/
...
/*** ISpPhrase methods ***/
static FORCEINLINE HRESULT ISpPhrase_GetPhrase(ISpPhrase* This,SPPHRASE **phrase) {
    return This->lpVtbl->GetPhrase(This,phrase);
}
static FORCEINLINE HRESULT ISpPhrase_GetSerializedPhrase(ISpPhrase* This,SPSERIALIZEDPHRASE **phrase) {
    return This->lpVtbl->GetSerializedPhrase(This,phrase);
}
static FORCEINLINE HRESULT ISpPhrase_GetText(ISpPhrase* This,ULONG start,ULONG count,BOOL replacements,WCHAR **text,BYTE *attributes) {
    return This->lpVtbl->GetText(This,start,count,replacements,text,attributes);
}
static FORCEINLINE HRESULT ISpPhrase_Discard(ISpPhrase* This,DWORD types) {
...
/*** ISpPhrase methods ***/
static FORCEINLINE HRESULT ISpPhraseAlt_GetPhrase(ISpPhraseAlt* This,SPPHRASE **phrase) {
    return This->lpVtbl->GetPhrase(This,phrase);
}
static FORCEINLINE HRESULT ISpPhraseAlt_GetSerializedPhrase(ISpPhraseAlt* This,SPSERIALIZEDPHRASE **phrase) {
    return This->lpVtbl->GetSerializedPhrase(This,phrase);
}
static FORCEINLINE HRESULT ISpPhraseAlt_GetText(ISpPhraseAlt* This,ULONG start,ULONG count,BOOL replacements,WCHAR **text,BYTE *attributes) {
    return This->lpVtbl->GetText(This,start,count,replacements,text,attributes);
}
static FORCEINLINE HRESULT ISpPhraseAlt_Discard(ISpPhraseAlt* This,DWORD types) {
    return This->lpVtbl->Discard(This,types);
}
/*** ISpPhraseAlt methods ***/
static FORCEINLINE HRESULT ISpPhraseAlt_GetAltInfo(ISpPhraseAlt* This,ISpPhrase **parent,ULONG *start,ULONG *count,ULONG *elements) {
...
/*** ISpPhrase methods ***/
static FORCEINLINE HRESULT ISpRecoResult_GetPhrase(ISpRecoResult* This,SPPHRASE **phrase) {
    return This->lpVtbl->GetPhrase(This,phrase);
}
static FORCEINLINE HRESULT ISpRecoResult_GetSerializedPhrase(ISpRecoResult* This,SPSERIALIZEDPHRASE **phrase) {
    return This->lpVtbl->GetSerializedPhrase(This,phrase);
}
static FORCEINLINE HRESULT ISpRecoResult_GetText(ISpRecoResult* This,ULONG start,ULONG count,BOOL replacements,WCHAR **text,BYTE *attributes) {
    return This->lpVtbl->GetText(This,start,count,replacements,text,attributes);
}
static FORCEINLINE HRESULT ISpRecoResult_Discard(ISpRecoResult* This,DWORD types) {
    return This->lpVtbl->Discard(This,types);
}
/*** ISpRecoResult methods ***/
static FORCEINLINE HRESULT ISpRecoResult_GetResultTimes(ISpRecoResult* This,SPRECORESULTTIMES *times) {
    return This->lpVtbl->GetResultTimes(This,times);
}
static FORCEINLINE HRESULT ISpRecoResult_GetAlternates(ISpRecoResult* This,ULONG start,ULONG elements,ULONG count,ISpPhraseAlt **phrases,ULONG *returned) {
    return This->lpVtbl->GetAlternates(This,start,elements,count,phrases,returned);
}
static FORCEINLINE HRESULT ISpRecoResult_GetAudio(ISpRecoResult* This,ULONG start,ULONG elements,ISpStreamFormat **stream) {
    return This->lpVtbl->GetAudio(This,start,elements,stream);
}
static FORCEINLINE HRESULT ISpRecoResult_SpeakAudio(ISpRecoResult* This,ULONG start,ULONG elements,DWORD flags,ULONG *number) {
    return This->lpVtbl->SpeakAudio(This,start,elements,flags,number);
}
static FORCEINLINE HRESULT ISpRecoResult_Serialize(ISpRecoResult* This,SPSERIALIZEDRESULT **result) {
    return This->lpVtbl->Serialize(This,result);
}
static FORCEINLINE HRESULT ISpRecoResult_ScaleAudio(ISpRecoResult* This,const GUID *format,const WAVEFORMATEX *wave) {
    return This->lpVtbl->ScaleAudio(This,format,wave);
}
static FORCEINLINE HRESULT ISpRecoResult_GetRecoContext(ISpRecoResult* This,ISpRecoContext *context) {
...
/*** ISpGrammarBuilder methods ***/
static FORCEINLINE HRESULT ISpGrammarBuilder_ResetGrammar(ISpGrammarBuilder* This,LANGID language) {
    return This->lpVtbl->ResetGrammar(This,language);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_GetRule(ISpGrammarBuilder* This,const WCHAR *rule,DWORD id,DWORD attributes,BOOL should_create,SPSTATEHANDLE *state) {
    return This->lpVtbl->GetRule(This,rule,id,attributes,should_create,state);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_ClearRule(ISpGrammarBuilder* This,SPSTATEHANDLE state) {
    return This->lpVtbl->ClearRule(This,state);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_CreateNewState(ISpGrammarBuilder* This,SPSTATEHANDLE instate,SPSTATEHANDLE *outstate) {
    return This->lpVtbl->CreateNewState(This,instate,outstate);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_AddWordTransition(ISpGrammarBuilder* This,SPSTATEHANDLE from_state,SPSTATEHANDLE to_state,const WCHAR *value,const WCHAR *separators,SPGRAMMARWORDTYPE type,float weight,const SPPROPERTYINFO *info) {
    return This->lpVtbl->AddWordTransition(This,from_state,to_state,value,separators,type,weight,info);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_AddRuleTransition(ISpGrammarBuilder* This,SPSTATEHANDLE from_state,SPSTATEHANDLE to_state,SPSTATEHANDLE rule,float weight,const SPPROPERTYINFO *info) {
    return This->lpVtbl->AddRuleTransition(This,from_state,to_state,rule,weight,info);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_AddResource(ISpGrammarBuilder* This,SPSTATEHANDLE state,const WCHAR *name,const WCHAR *value) {
    return This->lpVtbl->AddResource(This,state,name,value);
}
static FORCEINLINE HRESULT ISpGrammarBuilder_Commit(ISpGrammarBuilder* This,DWORD reserved) {
...
/*** ISpGrammarBuilder methods ***/
static FORCEINLINE HRESULT ISpRecoGrammar_ResetGrammar(ISpRecoGrammar* This,LANGID language) {
    return This->lpVtbl->ResetGrammar(This,language);
}
static FORCEINLINE HRESULT ISpRecoGrammar_GetRule(ISpRecoGrammar* This,const WCHAR *rule,DWORD id,DWORD attributes,BOOL should_create,SPSTATEHANDLE *state) {
    return This->lpVtbl->GetRule(This,rule,id,attributes,should_create,state);
}
static FORCEINLINE HRESULT ISpRecoGrammar_ClearRule(ISpRecoGrammar* This,SPSTATEHANDLE state) {
    return This->lpVtbl->ClearRule(This,state);
}
static FORCEINLINE HRESULT ISpRecoGrammar_CreateNewState(ISpRecoGrammar* This,SPSTATEHANDLE instate,SPSTATEHANDLE *outstate) {
    return This->lpVtbl->CreateNewState(This,instate,outstate);
}
static FORCEINLINE HRESULT ISpRecoGrammar_AddWordTransition(ISpRecoGrammar* This,SPSTATEHANDLE from_state,SPSTATEHANDLE to_state,const WCHAR *value,const WCHAR *separators,SPGRAMMARWORDTYPE type,float weight,const SPPROPERTYINFO *info) {
    return This->lpVtbl->AddWordTransition(This,from_state,to_state,value,separators,type,weight,info);
}
static FORCEINLINE HRESULT ISpRecoGrammar_AddRuleTransition(ISpRecoGrammar* This,SPSTATEHANDLE from_state,SPSTATEHANDLE to_state,SPSTATEHANDLE rule,float weight,const SPPROPERTYINFO *info) {
    return This->lpVtbl->AddRuleTransition(This,from_state,to_state,rule,weight,info);
}
static FORCEINLINE HRESULT ISpRecoGrammar_AddResource(ISpRecoGrammar* This,SPSTATEHANDLE state,const WCHAR *name,const WCHAR *value) {
    return This->lpVtbl->AddResource(This,state,name,value);
}
static FORCEINLINE HRESULT ISpRecoGrammar_Commit(ISpRecoGrammar* This,DWORD reserved) {
    return This->lpVtbl->Commit(This,reserved);
}
/*** ISpRecoGrammar methods ***/
static FORCEINLINE HRESULT ISpRecoGrammar_GetGrammarId(ISpRecoGrammar* This,ULONGLONG *grammar) {
    return This->lpVtbl->GetGrammarId(This,grammar);
}
static FORCEINLINE HRESULT ISpRecoGrammar_GetRecoContext(ISpRecoGrammar* This,ISpRecoContext **context) {
    return This->lpVtbl->GetRecoContext(This,context);
}
static FORCEINLINE HRESULT ISpRecoGrammar_LoadCmdFromFile(ISpRecoGrammar* This,const WCHAR *pszFileName,SPLOADOPTIONS options) {
    return This->lpVtbl->LoadCmdFromFile(This,pszFileName,options);
}
static FORCEINLINE HRESULT ISpRecoGrammar_LoadCmdFromObject(ISpRecoGrammar* This,REFCLSID rcid,const WCHAR *pszGrammarName,SPLOADOPTIONS options) {
    return This->lpVtbl->LoadCmdFromObject(This,rcid,pszGrammarName,options);
}
static FORCEINLINE HRESULT ISpRecoGrammar_LoadCmdFromResource(ISpRecoGrammar* This,HMODULE hmod,const WCHAR *name,const WCHAR *type,WORD language,SPLOADOPTIONS options) {
    return This->lpVtbl->LoadCmdFromResource(This,hmod,name,type,language,options);
}
static FORCEINLINE HRESULT ISpRecoGrammar_LoadCmdFromMemory(ISpRecoGrammar* This,const SPBINARYGRAMMAR *grammar,SPLOADOPTIONS options) {
    return This->lpVtbl->LoadCmdFromMemory(This,grammar,options);
}
static FORCEINLINE HRESULT ISpRecoGrammar_LoadCmdFromProprietaryGrammar(ISpRecoGrammar* This,REFGUID guid,const WCHAR *param,const void *data,ULONG size,SPLOADOPTIONS options) {
    return This->lpVtbl->LoadCmdFromProprietaryGrammar(This,guid,param,data,size,options);
}
static FORCEINLINE HRESULT ISpRecoGrammar_SetRuleState(ISpRecoGrammar* This,const WCHAR *name,void *reserved,SPRULESTATE state) {
    return This->lpVtbl->SetRuleState(This,name,reserved,state);
}
static FORCEINLINE HRESULT ISpRecoGrammar_SetRuleIdState(ISpRecoGrammar* This,ULONG rule,SPRULESTATE state) {
    return This->lpVtbl->SetRuleIdState(This,rule,state);
}
static FORCEINLINE HRESULT ISpRecoGrammar_LoadDictation(ISpRecoGrammar* This,const WCHAR *name,SPLOADOPTIONS options) {
...
static FORCEINLINE HRESULT ISpRecoGrammar_SetDictationState(ISpRecoGrammar* This,SPRULESTATE state) {
    return This->lpVtbl->SetDictationState(This,state);
}
static FORCEINLINE HRESULT ISpRecoGrammar_SetWordSequenceData(ISpRecoGrammar* This,const WCHAR *text,ULONG count,const SPTEXTSELECTIONINFO *info) {
    return This->lpVtbl->SetWordSequenceData(This,text,count,info);
}
static FORCEINLINE HRESULT ISpRecoGrammar_SetTextSelection(ISpRecoGrammar* This,const SPTEXTSELECTIONINFO *info) {
    return This->lpVtbl->SetTextSelection(This,info);
}
static FORCEINLINE HRESULT ISpRecoGrammar_IsPronounceable(ISpRecoGrammar* This,const WCHAR *word,SPWORDPRONOUNCEABLE *pronounceable) {
    return This->lpVtbl->IsPronounceable(This,word,pronounceable);
}
static FORCEINLINE HRESULT ISpRecoGrammar_SetGrammarState(ISpRecoGrammar* This,SPGRAMMARSTATE state) {
    return This->lpVtbl->SetGrammarState(This,state);
}
static FORCEINLINE HRESULT ISpRecoGrammar_SaveCmd(ISpRecoGrammar* This,IStream *stream,WCHAR **error) {
    return This->lpVtbl->SaveCmd(This,stream,error);
}
static FORCEINLINE HRESULT ISpRecoGrammar_GetGrammarState(ISpRecoGrammar* This,SPGRAMMARSTATE *state) {
...
/*** ISpNotifySource methods ***/
static FORCEINLINE HRESULT ISpVoice_SetNotifySink(ISpVoice* This,ISpNotifySink *sink) {
...
static FORCEINLINE HRESULT ISpVoice_SetNotifyCallbackFunction(ISpVoice* This,SPNOTIFYCALLBACK *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackFunction(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpVoice_SetNotifyCallbackInterface(ISpVoice* This,ISpNotifyCallback *callback,WPARAM wparam,LPARAM lparam) {
...
static FORCEINLINE HRESULT ISpVoice_WaitForNotifyEvent(ISpVoice* This,DWORD milliseconds) {
...
/*** ISpEventSource methods ***/
static FORCEINLINE HRESULT ISpVoice_SetInterest(ISpVoice* This,ULONGLONG event,ULONGLONG queued) {
    return This->lpVtbl->SetInterest(This,event,queued);
}
static FORCEINLINE HRESULT ISpVoice_GetEvents(ISpVoice* This,ULONG count,SPEVENT *array,ULONG *fetched) {
    return This->lpVtbl->GetEvents(This,count,array,fetched);
}
static FORCEINLINE HRESULT ISpVoice_GetInfo(ISpVoice* This,SPEVENTSOURCEINFO *info) {
    return This->lpVtbl->GetInfo(This,info);
}
/*** ISpVoice methods ***/
static FORCEINLINE HRESULT ISpVoice_SetOutput(ISpVoice* This,IUnknown *unk,BOOL changes) {
    return This->lpVtbl->SetOutput(This,unk,changes);
}
static FORCEINLINE HRESULT ISpVoice_GetOutputObjectToken(ISpVoice* This,ISpObjectToken **token) {
    return This->lpVtbl->GetOutputObjectToken(This,token);
}
static FORCEINLINE HRESULT ISpVoice_GetOutputStream(ISpVoice* This,ISpStreamFormat **stream) {
...
static FORCEINLINE HRESULT ISpVoice_SetVoice(ISpVoice* This,ISpObjectToken *token) {
    return This->lpVtbl->SetVoice(This,token);
}
static FORCEINLINE HRESULT ISpVoice_GetVoice(ISpVoice* This,ISpObjectToken **token) {
    return This->lpVtbl->GetVoice(This,token);
}
static FORCEINLINE HRESULT ISpVoice_Speak(ISpVoice* This,const WCHAR *pwcs,DWORD flags,ULONG *number) {
    return This->lpVtbl->Speak(This,pwcs,flags,number);
}
static FORCEINLINE HRESULT ISpVoice_SpeakStream(ISpVoice* This,IStream *stream,DWORD flags,ULONG *number) {
    return This->lpVtbl->SpeakStream(This,stream,flags,number);
}
static FORCEINLINE HRESULT ISpVoice_GetStatus(ISpVoice* This,SPVOICESTATUS *status,WCHAR **bookmark) {
    return This->lpVtbl->GetStatus(This,status,bookmark);
}
static FORCEINLINE HRESULT ISpVoice_Skip(ISpVoice* This,const WCHAR *type,LONG items,ULONG *skipped) {
    return This->lpVtbl->Skip(This,type,items,skipped);
}
static FORCEINLINE HRESULT ISpVoice_SetPriority(ISpVoice* This,SPVPRIORITY priority) {
    return This->lpVtbl->SetPriority(This,priority);
}
static FORCEINLINE HRESULT ISpVoice_GetPriority(ISpVoice* This,SPVPRIORITY *priority) {
    return This->lpVtbl->GetPriority(This,priority);
}
static FORCEINLINE HRESULT ISpVoice_SetAlertBoundary(ISpVoice* This,SPEVENTENUM boundary) {
    return This->lpVtbl->SetAlertBoundary(This,boundary);
}
static FORCEINLINE HRESULT ISpVoice_GetAlertBoundary(ISpVoice* This,SPEVENTENUM *boundary) {
    return This->lpVtbl->GetAlertBoundary(This,boundary);
}
static FORCEINLINE HRESULT ISpVoice_SetRate(ISpVoice* This,LONG adjust) {
    return This->lpVtbl->SetRate(This,adjust);
}
static FORCEINLINE HRESULT ISpVoice_GetRate(ISpVoice* This,LONG *adjust) {
    return This->lpVtbl->GetRate(This,adjust);
}
static FORCEINLINE HRESULT ISpVoice_SetVolume(ISpVoice* This,USHORT volume) {
    return This->lpVtbl->SetVolume(This,volume);
}
static FORCEINLINE HRESULT ISpVoice_GetVolume(ISpVoice* This,USHORT *volume) {
    return This->lpVtbl->GetVolume(This,volume);
}
static FORCEINLINE HRESULT ISpVoice_WaitUntilDone(ISpVoice* This,ULONG timeout) {
    return This->lpVtbl->WaitUntilDone(This,timeout);
}
static FORCEINLINE HRESULT ISpVoice_SetSyncSpeakTimeout(ISpVoice* This,ULONG timeout) {
    return This->lpVtbl->SetSyncSpeakTimeout(This,timeout);
}
static FORCEINLINE HRESULT ISpVoice_GetSyncSpeakTimeout(ISpVoice* This,ULONG *timeout) {
...
static FORCEINLINE HRESULT ISpVoice_IsUISupported(ISpVoice* This,const WCHAR *type,void *extra,ULONG count,BOOL *supported) {
    return This->lpVtbl->IsUISupported(This,type,extra,count,supported);
}
static FORCEINLINE HRESULT ISpVoice_DisplayUI(ISpVoice* This,HWND parent,const WCHAR *title,const WCHAR *type,void *extra,ULONG count) {
...
/*** ISpNotifySource methods ***/
static FORCEINLINE HRESULT ISpNotifySource_SetNotifySink(ISpNotifySource* This,ISpNotifySink *sink) {
    return This->lpVtbl->SetNotifySink(This,sink);
}
...
static FORCEINLINE HRESULT ISpNotifySource_SetNotifyCallbackFunction(ISpNotifySource* This,SPNOTIFYCALLBACK *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackFunction(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpNotifySource_SetNotifyCallbackInterface(ISpNotifySource* This,ISpNotifyCallback *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackInterface(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpNotifySource_SetNotifyWin32Event(ISpNotifySource* This) {
    return This->lpVtbl->SetNotifyWin32Event(This);
}
static FORCEINLINE HRESULT ISpNotifySource_WaitForNotifyEvent(ISpNotifySource* This,DWORD milliseconds) {
    return This->lpVtbl->WaitForNotifyEvent(This,milliseconds);
}
...
/*** ISpNotifySource methods ***/
static FORCEINLINE HRESULT ISpEventSource_SetNotifySink(ISpEventSource* This,ISpNotifySink *sink) {
    return This->lpVtbl->SetNotifySink(This,sink);
}
...
static FORCEINLINE HRESULT ISpEventSource_SetNotifyCallbackFunction(ISpEventSource* This,SPNOTIFYCALLBACK *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackFunction(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpEventSource_SetNotifyCallbackInterface(ISpEventSource* This,ISpNotifyCallback *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackInterface(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpEventSource_SetNotifyWin32Event(ISpEventSource* This) {
    return This->lpVtbl->SetNotifyWin32Event(This);
}
static FORCEINLINE HRESULT ISpEventSource_WaitForNotifyEvent(ISpEventSource* This,DWORD milliseconds) {
    return This->lpVtbl->WaitForNotifyEvent(This,milliseconds);
}
...
/*** ISpEventSource methods ***/
static FORCEINLINE HRESULT ISpEventSource_SetInterest(ISpEventSource* This,ULONGLONG event,ULONGLONG queued) {
    return This->lpVtbl->SetInterest(This,event,queued);
}
static FORCEINLINE HRESULT ISpEventSource_GetEvents(ISpEventSource* This,ULONG count,SPEVENT *array,ULONG *fetched) {
    return This->lpVtbl->GetEvents(This,count,array,fetched);
}
static FORCEINLINE HRESULT ISpEventSource_GetInfo(ISpEventSource* This,SPEVENTSOURCEINFO *info) {
    return This->lpVtbl->GetInfo(This,info);
}
#endif
#endif
...
/*** ISpNotifySource methods ***/
static FORCEINLINE HRESULT ISpRecoContext_SetNotifySink(ISpRecoContext* This,ISpNotifySink *sink) {
    return This->lpVtbl->SetNotifySink(This,sink);
}
...
static FORCEINLINE HRESULT ISpRecoContext_SetNotifyCallbackFunction(ISpRecoContext* This,SPNOTIFYCALLBACK *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackFunction(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpRecoContext_SetNotifyCallbackInterface(ISpRecoContext* This,ISpNotifyCallback *callback,WPARAM wparam,LPARAM lparam) {
    return This->lpVtbl->SetNotifyCallbackInterface(This,callback,wparam,lparam);
}
static FORCEINLINE HRESULT ISpRecoContext_SetNotifyWin32Event(ISpRecoContext* This) {
    return This->lpVtbl->SetNotifyWin32Event(This);
}
static FORCEINLINE HRESULT ISpRecoContext_WaitForNotifyEvent(ISpRecoContext* This,DWORD milliseconds) {
    return This->lpVtbl->WaitForNotifyEvent(This,milliseconds);
}
...
/*** ISpEventSource methods ***/
static FORCEINLINE HRESULT ISpRecoContext_SetInterest(ISpRecoContext* This,ULONGLONG event,ULONGLONG queued) {
    return This->lpVtbl->SetInterest(This,event,queued);
}
static FORCEINLINE HRESULT ISpRecoContext_GetEvents(ISpRecoContext* This,ULONG count,SPEVENT *array,ULONG *fetched) {
    return This->lpVtbl->GetEvents(This,count,array,fetched);
}
static FORCEINLINE HRESULT ISpRecoContext_GetInfo(ISpRecoContext* This,SPEVENTSOURCEINFO *info) {
    return This->lpVtbl->GetInfo(This,info);
}
/*** ISpRecoContext methods ***/
static FORCEINLINE HRESULT ISpRecoContext_GetRecognizer(ISpRecoContext* This,ISpRecognizer **recognizer) {
    return This->lpVtbl->GetRecognizer(This,recognizer);
}
static FORCEINLINE HRESULT ISpRecoContext_CreateGrammar(ISpRecoContext* This,ULONGLONG grammar,ISpRecoGrammar **spgrammar) {
    return This->lpVtbl->CreateGrammar(This,grammar,spgrammar);
}
static FORCEINLINE HRESULT ISpRecoContext_GetStatus(ISpRecoContext* This,SPRECOCONTEXTSTATUS *status) {
    return This->lpVtbl->GetStatus(This,status);
}
static FORCEINLINE HRESULT ISpRecoContext_GetMaxAlternates(ISpRecoContext* This,ULONG *alternates) {
    return This->lpVtbl->GetMaxAlternates(This,alternates);
}
static FORCEINLINE HRESULT ISpRecoContext_SetMaxAlternates(ISpRecoContext* This,ULONG alternates) {
    return This->lpVtbl->SetMaxAlternates(This,alternates);
}
static FORCEINLINE HRESULT ISpRecoContext_SetAudioOptions(ISpRecoContext* This,SPAUDIOOPTIONS options,const GUID *format,const WAVEFORMATEX *wave) {
    return This->lpVtbl->SetAudioOptions(This,options,format,wave);
}
static FORCEINLINE HRESULT ISpRecoContext_GetAudioOptions(ISpRecoContext* This,SPAUDIOOPTIONS *options,GUID *format,WAVEFORMATEX **wave) {
    return This->lpVtbl->GetAudioOptions(This,options,format,wave);
}
static FORCEINLINE HRESULT ISpRecoContext_DeserializeResult(ISpRecoContext* This,const SPSERIALIZEDRESULT *serialized,ISpRecoResult **result) {
    return This->lpVtbl->DeserializeResult(This,serialized,result);
}
static FORCEINLINE HRESULT ISpRecoContext_Bookmark(ISpRecoContext* This,SPBOOKMARKOPTIONS options,ULONGLONG position,LPARAM event) {
    return This->lpVtbl->Bookmark(This,options,position,event);
}
static FORCEINLINE HRESULT ISpRecoContext_SetAdaptationData(ISpRecoContext* This,const WCHAR *data,const ULONG count) {
    return This->lpVtbl->SetAdaptationData(This,data,count);
}
static FORCEINLINE HRESULT ISpRecoContext_Pause(ISpRecoContext* This,DWORD reserved) {
    return This->lpVtbl->Pause(This,reserved);
}
static FORCEINLINE HRESULT ISpRecoContext_Resume(ISpRecoContext* This,DWORD reserved) {
    return This->lpVtbl->Resume(This,reserved);
}
static FORCEINLINE HRESULT ISpRecoContext_SetVoice(ISpRecoContext* This,ISpVoice *voice,BOOL changes) {
    return This->lpVtbl->SetVoice(This,voice,changes);
}
static FORCEINLINE HRESULT ISpRecoContext_GetVoice(ISpRecoContext* This,ISpVoice **voice) {
    return This->lpVtbl->GetVoice(This,voice);
}
static FORCEINLINE HRESULT ISpRecoContext_SetVoicePurgeEvent(ISpRecoContext* This,ULONGLONG interest) {
    return This->lpVtbl->SetVoicePurgeEvent(This,interest);
}
static FORCEINLINE HRESULT ISpRecoContext_GetVoicePurgeEvent(ISpRecoContext* This,ULONGLONG *interest) {
    return This->lpVtbl->GetVoicePurgeEvent(This,interest);
}
static FORCEINLINE HRESULT ISpRecoContext_SetContextState(ISpRecoContext* This,SPCONTEXTSTATE state) {
    return This->lpVtbl->SetContextState(This,state);
}
static FORCEINLINE HRESULT ISpRecoContext_GetContextState(ISpRecoContext* This,SPCONTEXTSTATE *state) {
...
/*** ISpStreamFormat methods ***/
static FORCEINLINE HRESULT ISpStreamFormat_GetFormat(ISpStreamFormat* This,GUID *format,WAVEFORMATEX **wave) {
...
/*** ISpProperties methods ***/
static FORCEINLINE HRESULT ISpProperties_SetPropertyNum(ISpProperties* This,const WCHAR *name,LONG value) {
    return This->lpVtbl->SetPropertyNum(This,name,value);
}
static FORCEINLINE HRESULT ISpProperties_GetPropertyNum(ISpProperties* This,const WCHAR *name,LONG *value) {
    return This->lpVtbl->GetPropertyNum(This,name,value);
}
static FORCEINLINE HRESULT ISpProperties_SetPropertyString(ISpProperties* This,const WCHAR *name,const WCHAR *value) {
    return This->lpVtbl->SetPropertyString(This,name,value);
}
static FORCEINLINE HRESULT ISpProperties_GetPropertyString(ISpProperties* This,const WCHAR *name,WCHAR **value) {
...
/*** ISpProperties methods ***/
static FORCEINLINE HRESULT ISpRecognizer_SetPropertyNum(ISpRecognizer* This,const WCHAR *name,LONG value) {
    return This->lpVtbl->SetPropertyNum(This,name,value);
}
static FORCEINLINE HRESULT ISpRecognizer_GetPropertyNum(ISpRecognizer* This,const WCHAR *name,LONG *value) {
    return This->lpVtbl->GetPropertyNum(This,name,value);
}
static FORCEINLINE HRESULT ISpRecognizer_SetPropertyString(ISpRecognizer* This,const WCHAR *name,const WCHAR *value) {
    return This->lpVtbl->SetPropertyString(This,name,value);
}
static FORCEINLINE HRESULT ISpRecognizer_GetPropertyString(ISpRecognizer* This,const WCHAR *name,WCHAR **value) {
    return This->lpVtbl->GetPropertyString(This,name,value);
}
/*** ISpRecognizer methods ***/
static FORCEINLINE HRESULT ISpRecognizer_SetRecognizer(ISpRecognizer* This,ISpObjectToken *recognizer) {
    return This->lpVtbl->SetRecognizer(This,recognizer);
}
static FORCEINLINE HRESULT ISpRecognizer_GetRecognizer(ISpRecognizer* This,ISpObjectToken **recognizer) {
    return This->lpVtbl->GetRecognizer(This,recognizer);
}
static FORCEINLINE HRESULT ISpRecognizer_SetInput(ISpRecognizer* This,IUnknown *input,BOOL changes) {
    return This->lpVtbl->SetInput(This,input,changes);
}
static FORCEINLINE HRESULT ISpRecognizer_GetInputObjectToken(ISpRecognizer* This,ISpObjectToken **token) {
    return This->lpVtbl->GetInputObjectToken(This,token);
}
static FORCEINLINE HRESULT ISpRecognizer_GetInputStream(ISpRecognizer* This,ISpStreamFormat **stream) {
    return This->lpVtbl->GetInputStream(This,stream);
}
static FORCEINLINE HRESULT ISpRecognizer_CreateRecoContext(ISpRecognizer* This,ISpRecoContext **cxt) {
    return This->lpVtbl->CreateRecoContext(This,cxt);
}
static FORCEINLINE HRESULT ISpRecognizer_GetRecoProfile(ISpRecognizer* This,ISpObjectToken **token) {
    return This->lpVtbl->GetRecoProfile(This,token);
}
static FORCEINLINE HRESULT ISpRecognizer_SetRecoProfile(ISpRecognizer* This,ISpObjectToken *token) {
...
static FORCEINLINE HRESULT ISpRecognizer_GetRecoState(ISpRecognizer* This,SPRECOSTATE *state) {
    return This->lpVtbl->GetRecoState(This,state);
}
static FORCEINLINE HRESULT ISpRecognizer_SetRecoState(ISpRecognizer* This,SPRECOSTATE state) {
    return This->lpVtbl->SetRecoState(This,state);
}
static FORCEINLINE HRESULT ISpRecognizer_GetStatus(ISpRecognizer* This,SPRECOGNIZERSTATUS *status) {
    return This->lpVtbl->GetStatus(This,status);
}
static FORCEINLINE HRESULT ISpRecognizer_GetFormat(ISpRecognizer* This,SPSTREAMFORMATTYPE type,GUID *format,WAVEFORMATEX **wave) {
    return This->lpVtbl->GetFormat(This,type,format,wave);
}
static FORCEINLINE HRESULT ISpRecognizer_IsUISupported(ISpRecognizer* This,const WCHAR *type,void *extra,ULONG count,BOOL *supported) {
    return This->lpVtbl->IsUISupported(This,type,extra,count,supported);
}
static FORCEINLINE HRESULT ISpRecognizer_DisplayUI(ISpRecognizer* This,HWND hwnd,const WCHAR *title,const WCHAR *type,void *extra,ULONG cnt) {
    return This->lpVtbl->DisplayUI(This,hwnd,title,type,extra,cnt);
}
static FORCEINLINE HRESULT ISpRecognizer_EmulateRecognition(ISpRecognizer* This,ISpPhrase *phrase) {
...
/*** ISpStreamFormat methods ***/
static FORCEINLINE HRESULT ISpStream_GetFormat(ISpStream* This,GUID *format,WAVEFORMATEX **wave) {
    return This->lpVtbl->GetFormat(This,format,wave);
}
/*** ISpStream methods ***/
static FORCEINLINE HRESULT ISpStream_SetBaseStream(ISpStream* This,IStream *stream,REFGUID format,const WAVEFORMATEX *wave) {
    return This->lpVtbl->SetBaseStream(This,stream,format,wave);
}
static FORCEINLINE HRESULT ISpStream_GetBaseStream(ISpStream* This,IStream **stream) {
    return This->lpVtbl->GetBaseStream(This,stream);
}
static FORCEINLINE HRESULT ISpStream_BindToFile(ISpStream* This,LPCWSTR filename,SPFILEMODE mode,const GUID *format,const WAVEFORMATEX *wave,ULONGLONG interest) {
...
/*** ISpeechDataKey methods ***/
static FORCEINLINE HRESULT ISpeechDataKey_SetBinaryValue(ISpeechDataKey* This,const BSTR name,VARIANT value) {
    return This->lpVtbl->SetBinaryValue(This,name,value);
}
static FORCEINLINE HRESULT ISpeechDataKey_GetBinaryValue(ISpeechDataKey* This,const BSTR name,VARIANT *value) {
    return This->lpVtbl->GetBinaryValue(This,name,value);
}
static FORCEINLINE HRESULT ISpeechDataKey_SetStringValue(ISpeechDataKey* This,const BSTR name,const BSTR value) {
    return This->lpVtbl->SetStringValue(This,name,value);
}
static FORCEINLINE HRESULT ISpeechDataKey_GetStringValue(ISpeechDataKey* This,const BSTR name,BSTR *value) {
    return This->lpVtbl->GetStringValue(This,name,value);
}
static FORCEINLINE HRESULT ISpeechDataKey_SetLongValue(ISpeechDataKey* This,const BSTR name,LONG value) {
    return This->lpVtbl->SetLongValue(This,name,value);
}
static FORCEINLINE HRESULT ISpeechDataKey_GetLongValue(ISpeechDataKey* This,const BSTR name,LONG *value) {
    return This->lpVtbl->GetLongValue(This,name,value);
}
static FORCEINLINE HRESULT ISpeechDataKey_OpenKey(ISpeechDataKey* This,const BSTR name,ISpeechDataKey **key) {
    return This->lpVtbl->OpenKey(This,name,key);
}
static FORCEINLINE HRESULT ISpeechDataKey_CreateKey(ISpeechDataKey* This,const BSTR name,ISpeechDataKey **key) {
    return This->lpVtbl->CreateKey(This,name,key);
}
static FORCEINLINE HRESULT ISpeechDataKey_DeleteKey(ISpeechDataKey* This,const BSTR name) {
    return This->lpVtbl->DeleteKey(This,name);
}
static FORCEINLINE HRESULT ISpeechDataKey_DeleteValue(ISpeechDataKey* This,const BSTR name) {
    return This->lpVtbl->DeleteValue(This,name);
}
static FORCEINLINE HRESULT ISpeechDataKey_EnumKeys(ISpeechDataKey* This,LONG index,BSTR *name) {
    return This->lpVtbl->EnumKeys(This,index,name);
}
static FORCEINLINE HRESULT ISpeechDataKey_EnumValues(ISpeechDataKey* This,LONG Index,BSTR *value) {
...
static FORCEINLINE HRESULT ISpeechObjectTokenCategory_put_Default(ISpeechObjectTokenCategory* This,const BSTR token) {
    return This->lpVtbl->put_Default(This,token);
}
static FORCEINLINE HRESULT ISpeechObjectTokenCategory_get_Default(ISpeechObjectTokenCategory* This,BSTR *token) {
    return This->lpVtbl->get_Default(This,token);
}
static FORCEINLINE HRESULT ISpeechObjectTokenCategory_SetId(ISpeechObjectTokenCategory* This,const BSTR id,VARIANT_BOOL created) {
    return This->lpVtbl->SetId(This,id,created);
}
static FORCEINLINE HRESULT ISpeechObjectTokenCategory_GetDataKey(ISpeechObjectTokenCategory* This,SpeechDataKeyLocation location,ISpeechDataKey **key) {
    return This->lpVtbl->GetDataKey(This,location,key);
}
static FORCEINLINE HRESULT ISpeechObjectTokenCategory_EnumerateTokens(ISpeechObjectTokenCategory* This,BSTR required,BSTR optional,ISpeechObjectTokens **tokens) {
...
#define ISpeechObjectToken_RemoveStorageFileName(This,clsid,key,delete) (This)->lpVtbl->RemoveStorageFileName(This,clsid,key,delete)
...
/*** ISpeechObjectToken methods ***/
static FORCEINLINE HRESULT ISpeechObjectToken_get_Id(ISpeechObjectToken* This,BSTR *object) {
    return This->lpVtbl->get_Id(This,object);
}
static FORCEINLINE HRESULT ISpeechObjectToken_get_DataKey(ISpeechObjectToken* This,ISpeechDataKey **key) {
...
static FORCEINLINE HRESULT ISpeechObjectToken_SetId(ISpeechObjectToken* This,BSTR id,BSTR category,VARIANT_BOOL create) {
    return This->lpVtbl->SetId(This,id,category,create);
}
static FORCEINLINE HRESULT ISpeechObjectToken_GetAttribute(ISpeechObjectToken* This,BSTR name,BSTR *value) {
    return This->lpVtbl->GetAttribute(This,name,value);
}
static FORCEINLINE HRESULT ISpeechObjectToken_CreateInstance(ISpeechObjectToken* This,IUnknown *outer,SpeechTokenContext spcontext,IUnknown **object) {
    return This->lpVtbl->CreateInstance(This,outer,spcontext,object);
}
static FORCEINLINE HRESULT ISpeechObjectToken_Remove(ISpeechObjectToken* This,BSTR clsid) {
    return This->lpVtbl->Remove(This,clsid);
}
static FORCEINLINE HRESULT ISpeechObjectToken_GetStorageFileName(ISpeechObjectToken* This,BSTR clsid,BSTR key,BSTR name,SpeechTokenShellFolder folder,BSTR *path) {
    return This->lpVtbl->GetStorageFileName(This,clsid,key,name,folder,path);
}
static FORCEINLINE HRESULT ISpeechObjectToken_RemoveStorageFileName(ISpeechObjectToken* This,BSTR clsid,BSTR key,VARIANT_BOOL delete) {
    return This->lpVtbl->RemoveStorageFileName(This,clsid,key,delete);
}
static FORCEINLINE HRESULT ISpeechObjectToken_IsUISupported(ISpeechObjectToken* This,const BSTR type,const VARIANT *data,IUnknown *object,VARIANT_BOOL *supported) {
    return This->lpVtbl->IsUISupported(This,type,data,object,supported);
}
static FORCEINLINE HRESULT ISpeechObjectToken_DisplayUI(ISpeechObjectToken* This,LONG hwnd,BSTR title,const BSTR type,const VARIANT *data,IUnknown *object) {
...
static FORCEINLINE HRESULT ISpeechObjectTokens_get__NewEnum(ISpeechObjectTokens* This,IUnknown **ppenum) {
...
/*** ISpeechWaveFormatEx methods ***/
static FORCEINLINE HRESULT ISpeechWaveFormatEx_get_FormatTag(ISpeechWaveFormatEx* This,short *tag) {
    return This->lpVtbl->get_FormatTag(This,tag);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_put_FormatTag(ISpeechWaveFormatEx* This,short tag) {
...
static FORCEINLINE HRESULT ISpeechWaveFormatEx_get_SamplesPerSec(ISpeechWaveFormatEx* This,LONG *samples) {
    return This->lpVtbl->get_SamplesPerSec(This,samples);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_put_SamplesPerSec(ISpeechWaveFormatEx* This,LONG samples) {
    return This->lpVtbl->put_SamplesPerSec(This,samples);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_get_AvgBytesPerSec(ISpeechWaveFormatEx* This,LONG *average) {
    return This->lpVtbl->get_AvgBytesPerSec(This,average);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_put_AvgBytesPerSec(ISpeechWaveFormatEx* This,LONG average) {
    return This->lpVtbl->put_AvgBytesPerSec(This,average);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_get_BlockAlign(ISpeechWaveFormatEx* This,short *alignment) {
    return This->lpVtbl->get_BlockAlign(This,alignment);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_put_BlockAlign(ISpeechWaveFormatEx* This,short alignment) {
    return This->lpVtbl->put_BlockAlign(This,alignment);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_get_BitsPerSample(ISpeechWaveFormatEx* This,short *bits) {
    return This->lpVtbl->get_BitsPerSample(This,bits);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_put_BitsPerSample(ISpeechWaveFormatEx* This,short bits) {
    return This->lpVtbl->put_BitsPerSample(This,bits);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_get_ExtraData(ISpeechWaveFormatEx* This,VARIANT *data) {
    return This->lpVtbl->get_ExtraData(This,data);
}
static FORCEINLINE HRESULT ISpeechWaveFormatEx_put_ExtraData(ISpeechWaveFormatEx* This,VARIANT data) {
...
/*** ISpeechAudioFormat methods ***/
static FORCEINLINE HRESULT ISpeechAudioFormat_get_Type(ISpeechAudioFormat* This,SpeechAudioFormatType *format) {
    return This->lpVtbl->get_Type(This,format);
}
static FORCEINLINE HRESULT ISpeechAudioFormat_put_Type(ISpeechAudioFormat* This,SpeechAudioFormatType format) {
...
static FORCEINLINE HRESULT ISpeechAudioFormat_GetWaveFormatEx(ISpeechAudioFormat* This,ISpeechWaveFormatEx **speechwave) {
    return This->lpVtbl->GetWaveFormatEx(This,speechwave);
}
static FORCEINLINE HRESULT ISpeechAudioFormat_SetWaveFormatEx(ISpeechAudioFormat* This,ISpeechWaveFormatEx *speechwave) {
...
/*** ISpeechBaseStream methods ***/
static FORCEINLINE HRESULT ISpeechBaseStream_get_Format(ISpeechBaseStream* This,ISpeechAudioFormat **format) {
    return This->lpVtbl->get_Format(This,format);
}
static FORCEINLINE HRESULT ISpeechBaseStream_putref_Format(ISpeechBaseStream* This,ISpeechAudioFormat *format) {
    return This->lpVtbl->putref_Format(This,format);
}
static FORCEINLINE HRESULT ISpeechBaseStream_Read(ISpeechBaseStream* This,VARIANT *buffer,LONG written,LONG *read) {
    return This->lpVtbl->Read(This,buffer,written,read);
}
static FORCEINLINE HRESULT ISpeechBaseStream_Write(ISpeechBaseStream* This,VARIANT buffer,LONG *written) {
    return This->lpVtbl->Write(This,buffer,written);
}
static FORCEINLINE HRESULT ISpeechBaseStream_Seek(ISpeechBaseStream* This,VARIANT position,SpeechStreamSeekPositionType origin,VARIANT *pos) {
...
/*** ISpeechAudioStatus methods ***/
static FORCEINLINE HRESULT ISpeechAudioStatus_get_FreeBufferSpace(ISpeechAudioStatus* This,LONG *space) {
    return This->lpVtbl->get_FreeBufferSpace(This,space);
}
static FORCEINLINE HRESULT ISpeechAudioStatus_get_NonBlockingIO(ISpeechAudioStatus* This,LONG *nonblocking) {
...
static FORCEINLINE HRESULT ISpeechAudioStatus_get_CurrentSeekPosition(ISpeechAudioStatus* This,VARIANT *position) {
    return This->lpVtbl->get_CurrentSeekPosition(This,position);
}
static FORCEINLINE HRESULT ISpeechAudioStatus_get_CurrentDevicePosition(ISpeechAudioStatus* This,VARIANT *position) {
...
/*** ISpeechRecognizerStatus methods ***/
static FORCEINLINE HRESULT ISpeechRecognizerStatus_get_AudioStatus(ISpeechRecognizerStatus* This,ISpeechAudioStatus **audio) {
    return This->lpVtbl->get_AudioStatus(This,audio);
}
static FORCEINLINE HRESULT ISpeechRecognizerStatus_get_CurrentStreamPosition(ISpeechRecognizerStatus* This,VARIANT *pos) {
    return This->lpVtbl->get_CurrentStreamPosition(This,pos);
}
static FORCEINLINE HRESULT ISpeechRecognizerStatus_get_CurrentStreamNumber(ISpeechRecognizerStatus* This,LONG *number) {
    return This->lpVtbl->get_CurrentStreamNumber(This,number);
}
static FORCEINLINE HRESULT ISpeechRecognizerStatus_get_NumberOfActiveRules(ISpeechRecognizerStatus* This,LONG *rules) {
    return This->lpVtbl->get_NumberOfActiveRules(This,rules);
}
static FORCEINLINE HRESULT ISpeechRecognizerStatus_get_ClsidEngine(ISpeechRecognizerStatus* This,BSTR *clsid) {
    return This->lpVtbl->get_ClsidEngine(This,clsid);
}
static FORCEINLINE HRESULT ISpeechRecognizerStatus_get_SupportedLanguages(ISpeechRecognizerStatus* This,VARIANT *languages) {
...
/*** ISpeechVoiceStatus methods ***/
static FORCEINLINE HRESULT ISpeechVoiceStatus_get_CurrentStreamNumber(ISpeechVoiceStatus* This,LONG *number) {
    return This->lpVtbl->get_CurrentStreamNumber(This,number);
}
static FORCEINLINE HRESULT ISpeechVoiceStatus_get_LastStreamNumberQueued(ISpeechVoiceStatus* This,LONG *number) {
    return This->lpVtbl->get_LastStreamNumberQueued(This,number);
}
static FORCEINLINE HRESULT ISpeechVoiceStatus_get_LastHResult(ISpeechVoiceStatus* This,LONG *result) {
...
static FORCEINLINE HRESULT ISpeechVoiceStatus_get_LastBookmarkId(ISpeechVoiceStatus* This,LONG *bookmark) {
    return This->lpVtbl->get_LastBookmarkId(This,bookmark);
}
static FORCEINLINE HRESULT ISpeechVoiceStatus_get_PhonemeId(ISpeechVoiceStatus* This,short *phone) {
    return This->lpVtbl->get_PhonemeId(This,phone);
}
static FORCEINLINE HRESULT ISpeechVoiceStatus_get_VisemeId(ISpeechVoiceStatus* This,short *id) {
...
static FORCEINLINE HRESULT ISpeechVoice_get_AudioOutput(ISpeechVoice* This,ISpeechObjectToken **output) {
    return This->lpVtbl->get_AudioOutput(This,output);
}
static FORCEINLINE HRESULT ISpeechVoice_putref_AudioOutput(ISpeechVoice* This,ISpeechObjectToken *output) {
    return This->lpVtbl->putref_AudioOutput(This,output);
}
static FORCEINLINE HRESULT ISpeechVoice_get_AudioOutputStream(ISpeechVoice* This,ISpeechBaseStream **output) {
    return This->lpVtbl->get_AudioOutputStream(This,output);
}
static FORCEINLINE HRESULT ISpeechVoice_putref_AudioOutputStream(ISpeechVoice* This,ISpeechBaseStream *output) {
...
static FORCEINLINE HRESULT ISpeechVoice_get_EventInterests(ISpeechVoice* This,SpeechVoiceEvents *flags) {
    return This->lpVtbl->get_EventInterests(This,flags);
}
static FORCEINLINE HRESULT ISpeechVoice_put_EventInterests(ISpeechVoice* This,SpeechVoiceEvents flags) {
    return This->lpVtbl->put_EventInterests(This,flags);
}
static FORCEINLINE HRESULT ISpeechVoice_put_Priority(ISpeechVoice* This,SpeechVoicePriority vpriority) {
    return This->lpVtbl->put_Priority(This,vpriority);
}
static FORCEINLINE HRESULT ISpeechVoice_get_Priority(ISpeechVoice* This,SpeechVoicePriority *vpriority) {
...
static FORCEINLINE HRESULT ISpeechVoice_put_SynchronousSpeakTimeout(ISpeechVoice* This,LONG timeout) {
    return This->lpVtbl->put_SynchronousSpeakTimeout(This,timeout);
}
static FORCEINLINE HRESULT ISpeechVoice_get_SynchronousSpeakTimeout(ISpeechVoice* This,LONG *timeout) {
    return This->lpVtbl->get_SynchronousSpeakTimeout(This,timeout);
}
static FORCEINLINE HRESULT ISpeechVoice_Speak(ISpeechVoice* This,BSTR text,SpeechVoiceSpeakFlags flags,LONG *number) {
    return This->lpVtbl->Speak(This,text,flags,number);
}
static FORCEINLINE HRESULT ISpeechVoice_SpeakStream(ISpeechVoice* This,ISpeechBaseStream *stream,SpeechVoiceSpeakFlags flags,LONG *number) {
    return This->lpVtbl->SpeakStream(This,stream,flags,number);
}
...
static FORCEINLINE HRESULT ISpeechVoice_Skip(ISpeechVoice* This,const BSTR type,LONG items,LONG *skipped) {
    return This->lpVtbl->Skip(This,type,items,skipped);
}
static FORCEINLINE HRESULT ISpeechVoice_GetVoices(ISpeechVoice* This,BSTR required,BSTR optional,ISpeechObjectTokens **tokens) {
    return This->lpVtbl->GetVoices(This,required,optional,tokens);
}
static FORCEINLINE HRESULT ISpeechVoice_GetAudioOutputs(ISpeechVoice* This,BSTR required,BSTR optional,ISpeechObjectTokens **tokens) {
...
static FORCEINLINE HRESULT ISpeechVoice_IsUISupported(ISpeechVoice* This,const BSTR typeui,const VARIANT *data,VARIANT_BOOL *supported) {
    return This->lpVtbl->IsUISupported(This,typeui,data,supported);
}
static FORCEINLINE HRESULT ISpeechVoice_DisplayUI(ISpeechVoice* This,LONG hwnd,BSTR title,const BSTR typeui,const VARIANT *data) {
...
/*** ISpeechRecoResultTimes methods ***/
static FORCEINLINE HRESULT ISpeechRecoResultTimes_get_StreamTime(ISpeechRecoResultTimes* This,VARIANT *streamtime) {
...
static FORCEINLINE HRESULT ISpeechRecoResultTimes_get_TickCount(ISpeechRecoResultTimes* This,LONG *count) {
    return This->lpVtbl->get_TickCount(This,count);
}
static FORCEINLINE HRESULT ISpeechRecoResultTimes_get_OffsetFromStart(ISpeechRecoResultTimes* This,VARIANT *offset) {
...
static FORCEINLINE HRESULT ISpeechPhraseRules_get__NewEnum(ISpeechPhraseRules* This,IUnknown **obj) {
...
static FORCEINLINE HRESULT ISpeechPhraseRule_get_FirstElement(ISpeechPhraseRule* This,LONG *element) {
    return This->lpVtbl->get_FirstElement(This,element);
}
static FORCEINLINE HRESULT ISpeechPhraseRule_get_NumberOfElements(ISpeechPhraseRule* This,LONG *count) {
...
static FORCEINLINE HRESULT ISpeechPhraseRule_get_Confidence(ISpeechPhraseRule* This,SpeechEngineConfidence *confidence) {
    return This->lpVtbl->get_Confidence(This,confidence);
}
static FORCEINLINE HRESULT ISpeechPhraseRule_get_EngineConfidence(ISpeechPhraseRule* This,float *confidence) {
...
static FORCEINLINE HRESULT ISpeechPhraseProperty_get_FirstElement(ISpeechPhraseProperty* This,LONG *element) {
    return This->lpVtbl->get_FirstElement(This,element);
}
static FORCEINLINE HRESULT ISpeechPhraseProperty_get_NumberOfElements(ISpeechPhraseProperty* This,LONG *elements) {
...
static FORCEINLINE HRESULT ISpeechPhraseProperty_get_Parent(ISpeechPhraseProperty* This,ISpeechPhraseProperty **parent) {
    return This->lpVtbl->get_Parent(This,parent);
}
...
static FORCEINLINE HRESULT ISpeechPhraseProperties_Item(ISpeechPhraseProperties* This,LONG index,ISpeechPhraseProperty **obj) {
    return This->lpVtbl->Item(This,index,obj);
}
static FORCEINLINE HRESULT ISpeechPhraseProperties_get__NewEnum(ISpeechPhraseProperties* This,IUnknown **obj) {
    return This->lpVtbl->get__NewEnum(This,obj);
}
#endif
#endif
...
/*** ISpeechPhraseElement methods ***/
static FORCEINLINE HRESULT ISpeechPhraseElement_get_AudioTimeOffset(ISpeechPhraseElement* This,LONG *offset) {
    return This->lpVtbl->get_AudioTimeOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_AudioSizeTime(ISpeechPhraseElement* This,LONG *audiotime) {
    return This->lpVtbl->get_AudioSizeTime(This,audiotime);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_AudioStreamOffset(ISpeechPhraseElement* This,LONG *offset) {
    return This->lpVtbl->get_AudioStreamOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_AudioSizeBytes(ISpeechPhraseElement* This,LONG *bytes) {
    return This->lpVtbl->get_AudioSizeBytes(This,bytes);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_RetainedStreamOffset(ISpeechPhraseElement* This,LONG *offset) {
    return This->lpVtbl->get_RetainedStreamOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_RetainedSizeBytes(ISpeechPhraseElement* This,LONG *retained) {
    return This->lpVtbl->get_RetainedSizeBytes(This,retained);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_DisplayText(ISpeechPhraseElement* This,BSTR *display) {
    return This->lpVtbl->get_DisplayText(This,display);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_LexicalForm(ISpeechPhraseElement* This,BSTR *lexical) {
...
static FORCEINLINE HRESULT ISpeechPhraseElement_get_DisplayAttributes(ISpeechPhraseElement* This,SpeechDisplayAttributes *attributes) {
    return This->lpVtbl->get_DisplayAttributes(This,attributes);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_RequiredConfidence(ISpeechPhraseElement* This,SpeechEngineConfidence *confidence) {
    return This->lpVtbl->get_RequiredConfidence(This,confidence);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_ActualConfidence(ISpeechPhraseElement* This,SpeechEngineConfidence *confidence) {
    return This->lpVtbl->get_ActualConfidence(This,confidence);
}
static FORCEINLINE HRESULT ISpeechPhraseElement_get_EngineConfidence(ISpeechPhraseElement* This,float *confidence) {
    return This->lpVtbl->get_EngineConfidence(This,confidence);
}
#endif
#endif
...
static FORCEINLINE HRESULT ISpeechPhraseElements_get__NewEnum(ISpeechPhraseElements* This,IUnknown **obj) {
    return This->lpVtbl->get__NewEnum(This,obj);
}
#endif
#endif
...
/*** ISpeechPhraseReplacement methods ***/
static FORCEINLINE HRESULT ISpeechPhraseReplacement_get_DisplayAttributes(ISpeechPhraseReplacement* This,SpeechDisplayAttributes *attributes) {
    return This->lpVtbl->get_DisplayAttributes(This,attributes);
}
...
static FORCEINLINE HRESULT ISpeechPhraseReplacement_get_FirstElement(ISpeechPhraseReplacement* This,LONG *element) {
    return This->lpVtbl->get_FirstElement(This,element);
}
static FORCEINLINE HRESULT ISpeechPhraseReplacement_get_NumberOfElements(ISpeechPhraseReplacement* This,LONG *elements) {
    return This->lpVtbl->get_NumberOfElements(This,elements);
}
#endif
#endif
...
static FORCEINLINE HRESULT ISpeechPhraseReplacements_get__NewEnum(ISpeechPhraseReplacements* This,IUnknown **obj) {
    return This->lpVtbl->get__NewEnum(This,obj);
}
#endif
#endif
...
/*** ISpeechPhraseInfo methods ***/
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_LanguageId(ISpeechPhraseInfo* This,LONG *language) {
    return This->lpVtbl->get_LanguageId(This,language);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_GrammarId(ISpeechPhraseInfo* This,VARIANT *grammar) {
    return This->lpVtbl->get_GrammarId(This,grammar);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_StartTime(ISpeechPhraseInfo* This,VARIANT *start) {
    return This->lpVtbl->get_StartTime(This,start);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_AudioStreamPosition(ISpeechPhraseInfo* This,VARIANT *position) {
    return This->lpVtbl->get_AudioStreamPosition(This,position);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_AudioSizeBytes(ISpeechPhraseInfo* This,LONG *bytes) {
    return This->lpVtbl->get_AudioSizeBytes(This,bytes);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_RetainedSizeBytes(ISpeechPhraseInfo* This,LONG *bytes) {
    return This->lpVtbl->get_RetainedSizeBytes(This,bytes);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_AudioSizeTime(ISpeechPhraseInfo* This,LONG *audiotime) {
    return This->lpVtbl->get_AudioSizeTime(This,audiotime);
}
...
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_Properties(ISpeechPhraseInfo* This,ISpeechPhraseProperties **props) {
...
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_EngineId(ISpeechPhraseInfo* This,BSTR *engine) {
    return This->lpVtbl->get_EngineId(This,engine);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_get_EnginePrivateData(ISpeechPhraseInfo* This,VARIANT *data) {
    return This->lpVtbl->get_EnginePrivateData(This,data);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_SaveToMemory(ISpeechPhraseInfo* This,VARIANT *block) {
    return This->lpVtbl->SaveToMemory(This,block);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_GetText(ISpeechPhraseInfo* This,LONG start,LONG elements,VARIANT_BOOL replacements,BSTR *text) {
    return This->lpVtbl->GetText(This,start,elements,replacements,text);
}
static FORCEINLINE HRESULT ISpeechPhraseInfo_GetDisplayAttributes(ISpeechPhraseInfo* This,LONG start,LONG elements,VARIANT_BOOL replacements,SpeechDisplayAttributes *attributes) {
...
/*** ISpeechPhraseAlternate methods ***/
static FORCEINLINE HRESULT ISpeechPhraseAlternate_get_RecoResult(ISpeechPhraseAlternate* This,ISpeechRecoResult **result) {
    return This->lpVtbl->get_RecoResult(This,result);
}
static FORCEINLINE HRESULT ISpeechPhraseAlternate_get_StartElementInResult(ISpeechPhraseAlternate* This,LONG *element) {
    return This->lpVtbl->get_StartElementInResult(This,element);
}
static FORCEINLINE HRESULT ISpeechPhraseAlternate_get_NumberOfElementsInResult(ISpeechPhraseAlternate* This,LONG *elements) {
...
static FORCEINLINE HRESULT ISpeechPhraseAlternates_Item(ISpeechPhraseAlternates* This,LONG index,ISpeechPhraseAlternate **alternate) {
    return This->lpVtbl->Item(This,index,alternate);
}
static FORCEINLINE HRESULT ISpeechPhraseAlternates_get__NewEnum(ISpeechPhraseAlternates* This,IUnknown **obj) {
    return This->lpVtbl->get__NewEnum(This,obj);
}
#endif
#endif
...
/*** ISpeechBaseStream methods ***/
static FORCEINLINE HRESULT ISpeechMemoryStream_get_Format(ISpeechMemoryStream* This,ISpeechAudioFormat **format) {
    return This->lpVtbl->get_Format(This,format);
}
static FORCEINLINE HRESULT ISpeechMemoryStream_putref_Format(ISpeechMemoryStream* This,ISpeechAudioFormat *format) {
    return This->lpVtbl->putref_Format(This,format);
}
static FORCEINLINE HRESULT ISpeechMemoryStream_Read(ISpeechMemoryStream* This,VARIANT *buffer,LONG written,LONG *read) {
    return This->lpVtbl->Read(This,buffer,written,read);
}
static FORCEINLINE HRESULT ISpeechMemoryStream_Write(ISpeechMemoryStream* This,VARIANT buffer,LONG *written) {
    return This->lpVtbl->Write(This,buffer,written);
}
static FORCEINLINE HRESULT ISpeechMemoryStream_Seek(ISpeechMemoryStream* This,VARIANT position,SpeechStreamSeekPositionType origin,VARIANT *pos) {
    return This->lpVtbl->Seek(This,position,origin,pos);
}
/*** ISpeechMemoryStream methods ***/
...
static FORCEINLINE HRESULT ISpeechMemoryStream_GetData(ISpeechMemoryStream* This,VARIANT *data) {
...
static FORCEINLINE HRESULT ISpeechRecoResult_get_PhraseInfo(ISpeechRecoResult* This,ISpeechPhraseInfo **phrase) {
    return This->lpVtbl->get_PhraseInfo(This,phrase);
}
static FORCEINLINE HRESULT ISpeechRecoResult_Alternates(ISpeechRecoResult* This,LONG count,LONG start,LONG elements,ISpeechPhraseAlternates **alternates) {
    return This->lpVtbl->Alternates(This,count,start,elements,alternates);
}
static FORCEINLINE HRESULT ISpeechRecoResult_Audio(ISpeechRecoResult* This,LONG start,LONG elements,ISpeechMemoryStream **stream) {
    return This->lpVtbl->Audio(This,start,elements,stream);
}
static FORCEINLINE HRESULT ISpeechRecoResult_SpeakAudio(ISpeechRecoResult* This,LONG start,LONG elements,SpeechVoiceSpeakFlags flags,LONG *stream) {
    return This->lpVtbl->SpeakAudio(This,start,elements,flags,stream);
}
static FORCEINLINE HRESULT ISpeechRecoResult_SaveToMemory(ISpeechRecoResult* This,VARIANT *block) {
    return This->lpVtbl->SaveToMemory(This,block);
}
static FORCEINLINE HRESULT ISpeechRecoResult_DiscardResultInfo(ISpeechRecoResult* This,SpeechDiscardType types) {
...
static FORCEINLINE HRESULT ISpeechGrammarRuleStateTransition_get_PropertyName(ISpeechGrammarRuleStateTransition* This,BSTR *name) {
    return This->lpVtbl->get_PropertyName(This,name);
}
static FORCEINLINE HRESULT ISpeechGrammarRuleStateTransition_get_PropertyId(ISpeechGrammarRuleStateTransition* This,LONG *id) {
    return This->lpVtbl->get_PropertyId(This,id);
}
static FORCEINLINE HRESULT ISpeechGrammarRuleStateTransition_get_PropertyValue(ISpeechGrammarRuleStateTransition* This,VARIANT *value) {
    return This->lpVtbl->get_PropertyValue(This,value);
}
static FORCEINLINE HRESULT ISpeechGrammarRuleStateTransition_get_NextState(ISpeechGrammarRuleStateTransition* This,ISpeechGrammarRuleState **state) {
...
static FORCEINLINE HRESULT ISpeechGrammarRuleStateTransitions_get__NewEnum(ISpeechGrammarRuleStateTransitions* This,IUnknown **enum_var) {
...
static FORCEINLINE HRESULT ISpeechGrammarRuleState_AddWordTransition(ISpeechGrammarRuleState* This,ISpeechGrammarRuleState *state,const BSTR Words,const BSTR separators,SpeechGrammarWordType type,const BSTR name,LONG id,VARIANT *value,float weight) {
    return This->lpVtbl->AddWordTransition(This,state,Words,separators,type,name,id,value,weight);
}
static FORCEINLINE HRESULT ISpeechGrammarRuleState_AddRuleTransition(ISpeechGrammarRuleState* This,ISpeechGrammarRuleState *state,ISpeechGrammarRule *rule,const BSTR name,LONG id,VARIANT *value,float weight) {
    return This->lpVtbl->AddRuleTransition(This,state,rule,name,id,value,weight);
}
static FORCEINLINE HRESULT ISpeechGrammarRuleState_AddSpecialTransition(ISpeechGrammarRuleState* This,ISpeechGrammarRuleState *state,SpeechSpecialTransitionType type,const BSTR name,LONG id,VARIANT *value,float weight) {
...
static FORCEINLINE HRESULT ISpeechGrammarRule_AddResource(ISpeechGrammarRule* This,const BSTR name,const BSTR value) {
...
/*** ISpeechTextSelectionInformation methods ***/
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_put_ActiveOffset(ISpeechTextSelectionInformation* This,LONG offset) {
    return This->lpVtbl->put_ActiveOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_get_ActiveOffset(ISpeechTextSelectionInformation* This,LONG *offset) {
    return This->lpVtbl->get_ActiveOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_put_ActiveLength(ISpeechTextSelectionInformation* This,LONG length) {
    return This->lpVtbl->put_ActiveLength(This,length);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_get_ActiveLength(ISpeechTextSelectionInformation* This,LONG *length) {
    return This->lpVtbl->get_ActiveLength(This,length);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_put_SelectionOffset(ISpeechTextSelectionInformation* This,LONG offset) {
    return This->lpVtbl->put_SelectionOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_get_SelectionOffset(ISpeechTextSelectionInformation* This,LONG *offset) {
    return This->lpVtbl->get_SelectionOffset(This,offset);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_put_SelectionLength(ISpeechTextSelectionInformation* This,LONG length) {
    return This->lpVtbl->put_SelectionLength(This,length);
}
static FORCEINLINE HRESULT ISpeechTextSelectionInformation_get_SelectionLength(ISpeechTextSelectionInformation* This,LONG *length) {
...
static FORCEINLINE HRESULT ISpeechGrammarRules_FindRule(ISpeechGrammarRules* This,VARIANT id,ISpeechGrammarRule **rule) {
...
static FORCEINLINE HRESULT ISpeechGrammarRules_get__NewEnum(ISpeechGrammarRules* This,IUnknown **enum_var) {
    return This->lpVtbl->get__NewEnum(This,enum_var);
}
...
static FORCEINLINE HRESULT ISpeechGrammarRules_Add(ISpeechGrammarRules* This,BSTR name,SpeechRuleAttributes attributes,LONG id,ISpeechGrammarRule **rule) {
...
static FORCEINLINE HRESULT ISpeechGrammarRules_CommitAndSave(ISpeechGrammarRules* This,BSTR *text,VARIANT *stream) {
...
static FORCEINLINE HRESULT ISpeechRecoGrammar_get_RecoContext(ISpeechRecoGrammar* This,ISpeechRecoContext **context) {
...
static FORCEINLINE HRESULT ISpeechRecoGrammar_Reset(ISpeechRecoGrammar* This,SpeechLanguageId language) {
    return This->lpVtbl->Reset(This,language);
}
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdLoadFromFile(ISpeechRecoGrammar* This,const BSTR filename,SpeechLoadOption option) {
    return This->lpVtbl->CmdLoadFromFile(This,filename,option);
}
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdLoadFromObject(ISpeechRecoGrammar* This,const BSTR classid,const BSTR grammarname,SpeechLoadOption option) {
    return This->lpVtbl->CmdLoadFromObject(This,classid,grammarname,option);
}
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdLoadFromResource(ISpeechRecoGrammar* This,LONG mod,VARIANT name,VARIANT type,SpeechLanguageId language,SpeechLoadOption option) {
    return This->lpVtbl->CmdLoadFromResource(This,mod,name,type,language,option);
}
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdLoadFromMemory(ISpeechRecoGrammar* This,VARIANT data,SpeechLoadOption option) {
    return This->lpVtbl->CmdLoadFromMemory(This,data,option);
}
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdLoadFromProprietaryGrammar(ISpeechRecoGrammar* This,const BSTR guid,const BSTR string,VARIANT data,SpeechLoadOption option) {
...
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdSetRuleIdState(ISpeechRecoGrammar* This,LONG rule,SpeechRuleState State) {
    return This->lpVtbl->CmdSetRuleIdState(This,rule,State);
}
static FORCEINLINE HRESULT ISpeechRecoGrammar_DictationLoad(ISpeechRecoGrammar* This,const BSTR topic,SpeechLoadOption option) {
...
static FORCEINLINE HRESULT ISpeechRecoGrammar_SetWordSequenceData(ISpeechRecoGrammar* This,const BSTR text,LONG length,ISpeechTextSelectionInformation *info) {
...
static FORCEINLINE HRESULT ISpeechRecoGrammar_IsPronounceable(ISpeechRecoGrammar* This,const BSTR word,SpeechWordPronounceable *pronounceable) {
    return This->lpVtbl->IsPronounceable(This,word,pronounceable);
}
#endif
#endif
...
static FORCEINLINE HRESULT ISpeechRecoContext_get_RequestedUIType(ISpeechRecoContext* This,BSTR *type) {
...
static FORCEINLINE HRESULT ISpeechRecoContext_get_AllowVoiceFormatMatchingOnNextSet(ISpeechRecoContext* This,VARIANT_BOOL *allow) {
    return This->lpVtbl->get_AllowVoiceFormatMatchingOnNextSet(This,allow);
}
static FORCEINLINE HRESULT ISpeechRecoContext_put_VoicePurgeEvent(ISpeechRecoContext* This,SpeechRecoEvents interest) {
    return This->lpVtbl->put_VoicePurgeEvent(This,interest);
}
static FORCEINLINE HRESULT ISpeechRecoContext_get_VoicePurgeEvent(ISpeechRecoContext* This,SpeechRecoEvents *interest) {
    return This->lpVtbl->get_VoicePurgeEvent(This,interest);
}
static FORCEINLINE HRESULT ISpeechRecoContext_put_EventInterests(ISpeechRecoContext* This,SpeechRecoEvents interest) {
    return This->lpVtbl->put_EventInterests(This,interest);
}
static FORCEINLINE HRESULT ISpeechRecoContext_get_EventInterests(ISpeechRecoContext* This,SpeechRecoEvents *interest) {
    return This->lpVtbl->get_EventInterests(This,interest);
}
static FORCEINLINE HRESULT ISpeechRecoContext_put_CmdMaxAlternates(ISpeechRecoContext* This,LONG alternates) {
    return This->lpVtbl->put_CmdMaxAlternates(This,alternates);
}
static FORCEINLINE HRESULT ISpeechRecoContext_get_CmdMaxAlternates(ISpeechRecoContext* This,LONG *alternates) {
...
static FORCEINLINE HRESULT ISpeechRecoContext_CreateGrammar(ISpeechRecoContext* This,VARIANT id,ISpeechRecoGrammar **grammar) {
    return This->lpVtbl->CreateGrammar(This,id,grammar);
}
static FORCEINLINE HRESULT ISpeechRecoContext_CreateResultFromMemory(ISpeechRecoContext* This,VARIANT *block,ISpeechRecoResult **result) {
    return This->lpVtbl->CreateResultFromMemory(This,block,result);
}
static FORCEINLINE HRESULT ISpeechRecoContext_Bookmark(ISpeechRecoContext* This,SpeechBookmarkOptions options,VARIANT pos,VARIANT bookmark) {
    return This->lpVtbl->Bookmark(This,options,pos,bookmark);
}
static FORCEINLINE HRESULT ISpeechRecoContext_SetAdaptationData(ISpeechRecoContext* This,BSTR adaptation) {
...
static FORCEINLINE HRESULT ISpeechRecognizer_putref_AudioInput(ISpeechRecognizer* This,ISpeechObjectToken *input) {
    return This->lpVtbl->putref_AudioInput(This,input);
}
static FORCEINLINE HRESULT ISpeechRecognizer_get_AudioInput(ISpeechRecognizer* This,ISpeechObjectToken **input) {
    return This->lpVtbl->get_AudioInput(This,input);
}
static FORCEINLINE HRESULT ISpeechRecognizer_putref_AudioInputStream(ISpeechRecognizer* This,ISpeechBaseStream *input) {
    return This->lpVtbl->putref_AudioInputStream(This,input);
}
static FORCEINLINE HRESULT ISpeechRecognizer_get_AudioInputStream(ISpeechRecognizer* This,ISpeechBaseStream **input) {
...
static FORCEINLINE HRESULT ISpeechRecognizer_EmulateRecognition(ISpeechRecognizer* This,VARIANT elements,VARIANT *attributes,LONG id) {
    return This->lpVtbl->EmulateRecognition(This,elements,attributes,id);
}
static FORCEINLINE HRESULT ISpeechRecognizer_CreateRecoContext(ISpeechRecognizer* This,ISpeechRecoContext **ncontext) {
    return This->lpVtbl->CreateRecoContext(This,ncontext);
}
static FORCEINLINE HRESULT ISpeechRecognizer_GetFormat(ISpeechRecognizer* This,SpeechFormatType speechtype,ISpeechAudioFormat **audioformat) {
...
static FORCEINLINE HRESULT ISpeechRecognizer_IsUISupported(ISpeechRecognizer* This,const BSTR type,const VARIANT *data,VARIANT_BOOL *supported) {
    return This->lpVtbl->IsUISupported(This,type,data,supported);
}
static FORCEINLINE HRESULT ISpeechRecognizer_DisplayUI(ISpeechRecognizer* This,LONG hWnd,BSTR title,const BSTR type,const VARIANT *data) {
    return This->lpVtbl->DisplayUI(This,hWnd,title,type,data);
}
static FORCEINLINE HRESULT ISpeechRecognizer_GetRecognizers(ISpeechRecognizer* This,BSTR required,BSTR optional,ISpeechObjectTokens **tokens) {
    return This->lpVtbl->GetRecognizers(This,required,optional,tokens);
}
static FORCEINLINE HRESULT ISpeechRecognizer_GetAudioInputs(ISpeechRecognizer* This,BSTR required,BSTR optional,ISpeechObjectTokens **tokens) {
    return This->lpVtbl->GetAudioInputs(This,required,optional,tokens);
}
static FORCEINLINE HRESULT ISpeechRecognizer_GetProfiles(ISpeechRecognizer* This,BSTR required,BSTR optional,ISpeechObjectTokens **tokens) {
...
/*** ISpeechBaseStream methods ***/
static FORCEINLINE HRESULT ISpeechFileStream_get_Format(ISpeechFileStream* This,ISpeechAudioFormat **format) {
    return This->lpVtbl->get_Format(This,format);
}
static FORCEINLINE HRESULT ISpeechFileStream_putref_Format(ISpeechFileStream* This,ISpeechAudioFormat *format) {
    return This->lpVtbl->putref_Format(This,format);
}
static FORCEINLINE HRESULT ISpeechFileStream_Read(ISpeechFileStream* This,VARIANT *buffer,LONG written,LONG *read) {
    return This->lpVtbl->Read(This,buffer,written,read);
}
static FORCEINLINE HRESULT ISpeechFileStream_Write(ISpeechFileStream* This,VARIANT buffer,LONG *written) {
    return This->lpVtbl->Write(This,buffer,written);
}
static FORCEINLINE HRESULT ISpeechFileStream_Seek(ISpeechFileStream* This,VARIANT position,SpeechStreamSeekPositionType origin,VARIANT *pos) {
    return This->lpVtbl->Seek(This,position,origin,pos);
}
/*** ISpeechFileStream methods ***/
static FORCEINLINE HRESULT ISpeechFileStream_Open(ISpeechFileStream* This,BSTR filename,SpeechStreamFileMode mode,VARIANT_BOOL events) {
