/*** Autogenerated by WIDL 5.0.3 from d3d10.idl - Do not edit ***/
...
static FORCEINLINE void ID3D10Device_SetPredication(ID3D10Device* This,ID3D10Predicate *pPredicate,BOOL PredicateValue) {
...
static FORCEINLINE void ID3D10Device_GetPredication(ID3D10Device* This,ID3D10Predicate **ppPredicate,BOOL *pPredicateValue) {
...
static FORCEINLINE BOOL ID3D10Multithread_SetMultithreadProtected(ID3D10Multithread* This,BOOL bMTProtect) {
    return This->lpVtbl->SetMultithreadProtected(This,bMTProtect);
}
static FORCEINLINE BOOL ID3D10Multithread_GetMultithreadProtected(ID3D10Multithread* This) {
