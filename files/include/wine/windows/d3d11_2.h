/*** Autogenerated by WIDL 5.0.3 from d3d11_2.idl - Do not edit ***/
...
static FORCEINLINE void ID3D11DeviceContext2_SetPredication(ID3D11DeviceContext2* This,ID3D11Predicate *pPredicate,BOOL PredicateValue) {
...
static FORCEINLINE void ID3D11DeviceContext2_ExecuteCommandList(ID3D11DeviceContext2* This,ID3D11CommandList *pCommandList,BOOL RestoreContextState) {
...
static FORCEINLINE void ID3D11DeviceContext2_GetPredication(ID3D11DeviceContext2* This,ID3D11Predicate **ppPredicate,BOOL *pPredicateValue) {
...
static FORCEINLINE HRESULT ID3D11DeviceContext2_FinishCommandList(ID3D11DeviceContext2* This,BOOL RestoreDeferredContextState,ID3D11CommandList **ppCommandList) {
...
static FORCEINLINE BOOL ID3D11DeviceContext2_IsAnnotationEnabled(ID3D11DeviceContext2* This) {
