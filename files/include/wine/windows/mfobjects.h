/*** Autogenerated by WIDL 5.0.3 from mfobjects.idl - Do not edit ***/
...
typedef struct __WIDL_mfobjects_generated_name_00000028 *PWAVEFORMATEXTENSIBLE;
#endif
...
typedef enum __WIDL_mfobjects_generated_name_0000002A {
...
/*** IMFSampleOutputStream methods ***/
static FORCEINLINE HRESULT IMFSampleOutputStream_BeginWriteSample(IMFSampleOutputStream* This,IMFSample *sample,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginWriteSample(This,sample,callback,state);
}
static FORCEINLINE HRESULT IMFSampleOutputStream_EndWriteSample(IMFSampleOutputStream* This,IMFAsyncResult *result) {
...
/*** IMFDXGIDeviceManager methods ***/
static FORCEINLINE HRESULT IMFDXGIDeviceManager_CloseDeviceHandle(IMFDXGIDeviceManager* This,HANDLE device) {
    return This->lpVtbl->CloseDeviceHandle(This,device);
}
static FORCEINLINE HRESULT IMFDXGIDeviceManager_GetVideoService(IMFDXGIDeviceManager* This,HANDLE device,REFIID riid,void **service) {
    return This->lpVtbl->GetVideoService(This,device,riid,service);
}
static FORCEINLINE HRESULT IMFDXGIDeviceManager_LockDevice(IMFDXGIDeviceManager* This,HANDLE device,REFIID riid,void **ppv,BOOL block) {
    return This->lpVtbl->LockDevice(This,device,riid,ppv,block);
}
static FORCEINLINE HRESULT IMFDXGIDeviceManager_OpenDeviceHandle(IMFDXGIDeviceManager* This,HANDLE *device) {
    return This->lpVtbl->OpenDeviceHandle(This,device);
}
static FORCEINLINE HRESULT IMFDXGIDeviceManager_ResetDevice(IMFDXGIDeviceManager* This,IUnknown *device,UINT token) {
    return This->lpVtbl->ResetDevice(This,device,token);
}
static FORCEINLINE HRESULT IMFDXGIDeviceManager_TestDevice(IMFDXGIDeviceManager* This,HANDLE device) {
    return This->lpVtbl->TestDevice(This,device);
}
static FORCEINLINE HRESULT IMFDXGIDeviceManager_UnlockDevice(IMFDXGIDeviceManager* This,HANDLE device,BOOL state) {
