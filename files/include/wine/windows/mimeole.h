/*** Autogenerated by WIDL 5.0.3 from mimeole.idl - Do not edit ***/
...
/*** IMimeEnumHeaderRows methods ***/
static FORCEINLINE HRESULT IMimeEnumHeaderRows_Next(IMimeEnumHeaderRows* This,ULONG fetch,LPENUMHEADERROW row,ULONG *fetched) {
    return This->lpVtbl->Next(This,fetch,row,fetched);
}
static FORCEINLINE HRESULT IMimeEnumHeaderRows_Skip(IMimeEnumHeaderRows* This,ULONG items) {
    return This->lpVtbl->Skip(This,items);
}
static FORCEINLINE HRESULT IMimeEnumHeaderRows_Reset(IMimeEnumHeaderRows* This) {
    return This->lpVtbl->Reset(This);
}
static FORCEINLINE HRESULT IMimeEnumHeaderRows_Clone(IMimeEnumHeaderRows* This,IMimeEnumHeaderRows **rows) {
    return This->lpVtbl->Clone(This,rows);
}
static FORCEINLINE HRESULT IMimeEnumHeaderRows_Count(IMimeEnumHeaderRows* This,ULONG *pcItems) {
...
/*** IMimeHeaderTable methods ***/
static FORCEINLINE HRESULT IMimeHeaderTable_FindFirstRow(IMimeHeaderTable* This,LPFINDHEADER header,LPHHEADERROW row) {
    return This->lpVtbl->FindFirstRow(This,header,row);
}
static FORCEINLINE HRESULT IMimeHeaderTable_FindNextRow(IMimeHeaderTable* This,LPFINDHEADER header,LPHHEADERROW row) {
    return This->lpVtbl->FindNextRow(This,header,row);
}
static FORCEINLINE HRESULT IMimeHeaderTable_CountRows(IMimeHeaderTable* This,const char *header,ULONG *rows) {
    return This->lpVtbl->CountRows(This,header,rows);
}
static FORCEINLINE HRESULT IMimeHeaderTable_AppendRow(IMimeHeaderTable* This,const char *header,DWORD flags,const char *data,ULONG count,LPHHEADERROW row) {
    return This->lpVtbl->AppendRow(This,header,flags,data,count,row);
}
static FORCEINLINE HRESULT IMimeHeaderTable_DeleteRow(IMimeHeaderTable* This,HHEADERROW row) {
    return This->lpVtbl->DeleteRow(This,row);
}
static FORCEINLINE HRESULT IMimeHeaderTable_GetRowData(IMimeHeaderTable* This,HHEADERROW row,DWORD flags,char **data,ULONG *len) {
    return This->lpVtbl->GetRowData(This,row,flags,data,len);
}
static FORCEINLINE HRESULT IMimeHeaderTable_SetRowData(IMimeHeaderTable* This,HHEADERROW row,DWORD flags,const char *data,ULONG len) {
    return This->lpVtbl->SetRowData(This,row,flags,data,len);
}
static FORCEINLINE HRESULT IMimeHeaderTable_GetRowInfo(IMimeHeaderTable* This,HHEADERROW row,LPHEADERROWINFO info) {
    return This->lpVtbl->GetRowInfo(This,row,info);
}
static FORCEINLINE HRESULT IMimeHeaderTable_SetRowNumber(IMimeHeaderTable* This,HHEADERROW row,DWORD number) {
    return This->lpVtbl->SetRowNumber(This,row,number);
}
static FORCEINLINE HRESULT IMimeHeaderTable_EnumRows(IMimeHeaderTable* This,const char *header,DWORD flags,IMimeEnumHeaderRows **rows) {
    return This->lpVtbl->EnumRows(This,header,flags,rows);
}
static FORCEINLINE HRESULT IMimeHeaderTable_Clone(IMimeHeaderTable* This,IMimeHeaderTable **table) {
    return This->lpVtbl->Clone(This,table);
}
static FORCEINLINE HRESULT IMimeHeaderTable_BindToObject(IMimeHeaderTable* This,REFIID riid,void *object) {
